...
namespace OpenInfraPlatform
{
	namespace Ifc2x3
	{
		...
		void IfcRoundedRectangleProfileDef::setEntity( shared_ptr<Ifc2x3Entity> other_entity )
		{
		...
		void IfcRoundedRectangleProfileDef::setInverseCounterparts( shared_ptr<Ifc2x3Entity> ptr_self_entity )
		{
