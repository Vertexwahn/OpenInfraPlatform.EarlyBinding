...
namespace OpenInfraPlatform
{
	namespace Ifc2x3
	{
		...
		void IfcStructuralLoadLinearForce::setEntity( shared_ptr<Ifc2x3Entity> other_entity )
		{
		...
		void IfcStructuralLoadLinearForce::setInverseCounterparts( shared_ptr<Ifc2x3Entity> ptr_self_entity )
		{
