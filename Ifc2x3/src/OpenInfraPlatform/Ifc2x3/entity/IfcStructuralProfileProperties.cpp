...
#include "include/IfcStructuralProfileProperties.h"
...
namespace OpenInfraPlatform
{
	namespace Ifc2x3
	{
		...
		IfcStructuralProfileProperties::IfcStructuralProfileProperties() { m_entity_enum = IFCSTRUCTURALPROFILEPROPERTIES; }
		IfcStructuralProfileProperties::IfcStructuralProfileProperties( int id ) { m_id = id; m_entity_enum = IFCSTRUCTURALPROFILEPROPERTIES; }
		IfcStructuralProfileProperties::~IfcStructuralProfileProperties() {}

		// method setEntity takes over all attributes from another instance of the class
		void IfcStructuralProfileProperties::setEntity( shared_ptr<Ifc2x3Entity> other_entity )
		{
			shared_ptr<IfcStructuralProfileProperties> other = dynamic_pointer_cast<IfcStructuralProfileProperties>(other_entity);
			if( !other) { return; }
		...
		void IfcStructuralProfileProperties::getStepLine( std::stringstream& stream ) const
		{
			stream << "#" << m_id << "=IFCSTRUCTURALPROFILEPROPERTIES" << "(";
		...
		void IfcStructuralProfileProperties::getStepParameter( std::stringstream& stream, bool ) const { stream << "#" << m_id; }
		void IfcStructuralProfileProperties::readStepData( std::vector<std::string>& args, const std::map<int,shared_ptr<Ifc2x3Entity> >& map )
		{
			const int num_args = (int)args.size();
			if( num_args<23 ){ std::stringstream strserr; strserr << "Wrong parameter count for entity IfcStructuralProfileProperties, expecting 23, having " << num_args << ". Object id: " << getId() << std::endl; throw Ifc2x3Exception( strserr.str().c_str() ); }
			#ifdef _DEBUG
			if( num_args>23 ){ std::cout << "Wrong parameter count for entity IfcStructuralProfileProperties, expecting 23, having " << num_args << ". Object id: " << getId() << std::endl; }
			#endif
		...
		void IfcStructuralProfileProperties::setInverseCounterparts( shared_ptr<Ifc2x3Entity> ptr_self_entity )
		{
			IfcGeneralProfileProperties::setInverseCounterparts( ptr_self_entity );
		}
		void IfcStructuralProfileProperties::unlinkSelf()
		{
			IfcGeneralProfileProperties::unlinkSelf();
		}
