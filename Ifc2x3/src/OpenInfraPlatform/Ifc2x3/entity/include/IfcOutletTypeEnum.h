...
namespace OpenInfraPlatform
{
	namespace Ifc2x3
	{
		// TYPE IfcOutletTypeEnum = ENUMERATION OF	(AUDIOVISUALOUTLET	,COMMUNICATIONSOUTLET	,POWEROUTLET	,USERDEFINED	,NOTDEFINED);
		class IfcOutletTypeEnum : public Ifc2x3AbstractEnum, public Ifc2x3Type
		{
		public:
