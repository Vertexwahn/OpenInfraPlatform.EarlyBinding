...
namespace OpenInfraPlatform
{
	namespace Ifc2x3
	{
		...
		//ENTITY
		class IfcDocumentInformation : public IfcDocumentSelect, public Ifc2x3Entity
		{
		public:
			...
			std::vector<shared_ptr<IfcDocumentReference> >				m_DocumentReferences;		//optional
			...
			shared_ptr<IfcDateAndTime>									m_CreationTime;				//optional
			shared_ptr<IfcDateAndTime>									m_LastRevisionTime;			//optional
			shared_ptr<IfcDocumentElectronicFormat>						m_ElectronicFormat;			//optional
			shared_ptr<IfcCalendarDate>									m_ValidFrom;				//optional
			shared_ptr<IfcCalendarDate>									m_ValidUntil;				//optional
