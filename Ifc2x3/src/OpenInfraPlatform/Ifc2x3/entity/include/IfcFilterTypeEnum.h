...
namespace OpenInfraPlatform
{
	namespace Ifc2x3
	{
		// TYPE IfcFilterTypeEnum = ENUMERATION OF	(AIRPARTICLEFILTER	,ODORFILTER	,OILFILTER	,STRAINER	,WATERFILTER	,USERDEFINED	,NOTDEFINED);
		class IfcFilterTypeEnum : public Ifc2x3AbstractEnum, public Ifc2x3Type
		{
		public:
