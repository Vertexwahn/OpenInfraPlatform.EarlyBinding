...
namespace OpenInfraPlatform
{
	namespace Ifc2x3
	{
		...
		public:
			...
			IfcRelAssociatesAppliedValue( int id );
			~IfcRelAssociatesAppliedValue();
			...
			virtual const char* classname() const { return "IfcRelAssociatesAppliedValue"; }
			...
			// IfcRelAssociatesAppliedValue -----------------------------------------------------------
			// attributes:
			shared_ptr<IfcAppliedValue>					m_RelatingAppliedValue;
		};
