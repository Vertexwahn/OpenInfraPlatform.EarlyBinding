...
namespace OpenInfraPlatform
{
	namespace Ifc2x3
	{
		...
		public:
			...
			virtual const char* classname() const { return "IfcConditionCriterion"; }
			...
			// IfcConditionCriterion -----------------------------------------------------------
			// attributes:
			shared_ptr<IfcConditionCriterionSelect>		m_Criterion;
			shared_ptr<IfcDateTimeSelect>				m_CriterionDateTime;
		};
