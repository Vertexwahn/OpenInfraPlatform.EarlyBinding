...
namespace OpenInfraPlatform
{
	namespace Ifc2x3
	{
		...
		public:
			...
			virtual const char* classname() const { return "IfcDefinedSymbol"; }
			...
			// IfcDefinedSymbol -----------------------------------------------------------
			// attributes:
			shared_ptr<IfcDefinedSymbolSelect>				m_Definition;
			shared_ptr<IfcCartesianTransformationOperator2D>	m_Target;
		};
