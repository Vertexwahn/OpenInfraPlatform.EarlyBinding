...
namespace OpenInfraPlatform
{
	namespace Ifc2x3
	{
		...
		public:
			...
			virtual const char* classname() const { return "IfcAnnotationSurface"; }
			...
			// IfcAnnotationSurface -----------------------------------------------------------
			// attributes:
			shared_ptr<IfcGeometricRepresentationItem>	m_Item;
			shared_ptr<IfcTextureCoordinate>				m_TextureCoordinates;		//optional
		};
