...
namespace OpenInfraPlatform
{
	...
	{
		//ENTITY
		class IfcAnnotationSymbolOccurrence : public IfcDraughtingCalloutElement, public IfcAnnotationOccurrence
		{
		public:
			IfcAnnotationSymbolOccurrence();
			IfcAnnotationSymbolOccurrence( int id );
			~IfcAnnotationSymbolOccurrence();
			...
			virtual const char* classname() const { return "IfcAnnotationSymbolOccurrence"; }
