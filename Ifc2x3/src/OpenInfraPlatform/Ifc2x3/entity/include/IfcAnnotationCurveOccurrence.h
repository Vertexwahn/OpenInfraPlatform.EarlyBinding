...
namespace OpenInfraPlatform
{
	...
	{
		//ENTITY
		class IfcAnnotationCurveOccurrence : public IfcDraughtingCalloutElement, public IfcAnnotationOccurrence
		{
		public:
			IfcAnnotationCurveOccurrence();
			IfcAnnotationCurveOccurrence( int id );
			~IfcAnnotationCurveOccurrence();
			...
			virtual const char* classname() const { return "IfcAnnotationCurveOccurrence"; }
