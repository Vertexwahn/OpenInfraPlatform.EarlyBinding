...
namespace OpenInfraPlatform
{
	namespace Ifc2x3
	{
		...
		public:
			...
			// IfcTransportElement -----------------------------------------------------------
			// attributes:
			shared_ptr<IfcTransportElementTypeEnum>		m_OperationType;			//optional
			shared_ptr<IfcMassMeasure>					m_CapacityByWeight;			//optional
			shared_ptr<IfcCountMeasure>					m_CapacityByNumber;			//optional
		};
