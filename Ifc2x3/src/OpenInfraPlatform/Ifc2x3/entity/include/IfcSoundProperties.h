...
namespace OpenInfraPlatform
{
	namespace Ifc2x3
	{
		...
		public:
			...
			virtual const char* classname() const { return "IfcSoundProperties"; }
			...
			// IfcSoundProperties -----------------------------------------------------------
			// attributes:
			shared_ptr<IfcBoolean>						m_IsAttenuating;
			shared_ptr<IfcSoundScaleEnum>				m_SoundScale;				//optional
			std::vector<shared_ptr<IfcSoundValue> >		m_SoundValues;
		};
