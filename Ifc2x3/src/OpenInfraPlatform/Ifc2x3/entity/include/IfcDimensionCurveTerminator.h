...
namespace OpenInfraPlatform
{
	namespace Ifc2x3
	{
		...
		public:
			...
			IfcDimensionCurveTerminator( int id );
			~IfcDimensionCurveTerminator();
			...
			virtual const char* classname() const { return "IfcDimensionCurveTerminator"; }
			...
			// IfcTerminatorSymbol -----------------------------------------------------------
			// attributes:
			//  shared_ptr<IfcAnnotationCurveOccurrence>		m_AnnotatedCurve;

			// IfcDimensionCurveTerminator -----------------------------------------------------------
			// attributes:
			shared_ptr<IfcDimensionExtentUsage>			m_Role;
		};
