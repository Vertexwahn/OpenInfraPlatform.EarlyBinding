...
namespace OpenInfraPlatform
{
	namespace Ifc2x3
	{
		...
		public:
			...
			virtual const char* classname() const { return "IfcServiceLife"; }
			...
			// IfcServiceLife -----------------------------------------------------------
			// attributes:
			shared_ptr<IfcServiceLifeTypeEnum>			m_ServiceLifeType;
			shared_ptr<IfcTimeMeasure>					m_ServiceLifeDuration;
		};
