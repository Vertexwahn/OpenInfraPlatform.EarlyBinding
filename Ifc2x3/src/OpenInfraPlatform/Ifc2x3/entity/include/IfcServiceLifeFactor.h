...
namespace OpenInfraPlatform
{
	namespace Ifc2x3
	{
		...
		public:
			...
			virtual const char* classname() const { return "IfcServiceLifeFactor"; }
			...
			// IfcServiceLifeFactor -----------------------------------------------------------
			// attributes:
			shared_ptr<IfcServiceLifeFactorTypeEnum>		m_PredefinedType;
			shared_ptr<IfcMeasureValue>					m_UpperValue;				//optional
			shared_ptr<IfcMeasureValue>					m_MostUsedValue;
			shared_ptr<IfcMeasureValue>					m_LowerValue;				//optional
		};
