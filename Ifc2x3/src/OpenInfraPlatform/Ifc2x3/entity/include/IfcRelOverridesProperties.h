...
namespace OpenInfraPlatform
{
	namespace Ifc2x3
	{
		...
		public:
			...
			IfcRelOverridesProperties( int id );
			~IfcRelOverridesProperties();
			...
			virtual const char* classname() const { return "IfcRelOverridesProperties"; }
			...
			// IfcRelOverridesProperties -----------------------------------------------------------
			// attributes:
			std::vector<shared_ptr<IfcProperty> >		m_OverridingProperties;
		};
