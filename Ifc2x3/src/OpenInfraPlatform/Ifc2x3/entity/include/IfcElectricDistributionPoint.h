...
namespace OpenInfraPlatform
{
	namespace Ifc2x3
	{
		...
		public:
			...
			IfcElectricDistributionPoint( int id );
			~IfcElectricDistributionPoint();
			...
			virtual const char* classname() const { return "IfcElectricDistributionPoint"; }
			...
			// IfcElectricDistributionPoint -----------------------------------------------------------
			// attributes:
			shared_ptr<IfcElectricDistributionPointFunctionEnum>	m_DistributionPointFunction;
			shared_ptr<IfcLabel>									m_UserDefinedFunction;		//optional
		};
