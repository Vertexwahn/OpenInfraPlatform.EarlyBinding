...
namespace OpenInfraPlatform
{
	namespace Ifc2x3
	{
		...
		public:
			...
			// attributes:
			//  shared_ptr<IfcIdentifier>					m_ResourceIdentifier;		//optional
			//  shared_ptr<IfcLabel>							m_ResourceGroup;			//optional
			//  shared_ptr<IfcResourceConsumptionEnum>		m_ResourceConsumption;		//optional
			//  shared_ptr<IfcMeasureWithUnit>				m_BaseQuantity;				//optional

			// IfcConstructionMaterialResource -----------------------------------------------------------
			// attributes:
			std::vector<shared_ptr<IfcActorSelect> >		m_Suppliers;				//optional
			shared_ptr<IfcRatioMeasure>					m_UsageRatio;				//optional
		};
