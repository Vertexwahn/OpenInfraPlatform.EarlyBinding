...
namespace OpenInfraPlatform
{
	namespace Ifc2x3
	{
		...
		public:
			...
			virtual const char* classname() const { return "IfcChamferEdgeFeature"; }
			...
			// IfcEdgeFeature -----------------------------------------------------------
			// attributes:
			//  shared_ptr<IfcPositiveLengthMeasure>			m_FeatureLength;			//optional

			// IfcChamferEdgeFeature -----------------------------------------------------------
			// attributes:
			shared_ptr<IfcPositiveLengthMeasure>			m_Width;					//optional
			shared_ptr<IfcPositiveLengthMeasure>			m_Height;					//optional
		};
