...
namespace OpenInfraPlatform
{
	namespace Ifc2x3
	{
		...
		public:
			...
			IfcAnnotationFillAreaOccurrence( int id );
			~IfcAnnotationFillAreaOccurrence();
			...
			virtual const char* classname() const { return "IfcAnnotationFillAreaOccurrence"; }
			...
			// IfcAnnotationFillAreaOccurrence -----------------------------------------------------------
			// attributes:
			shared_ptr<IfcPoint>							m_FillStyleTarget;			//optional
			shared_ptr<IfcGlobalOrLocalEnum>				m_GlobalOrLocal;			//optional
		};
