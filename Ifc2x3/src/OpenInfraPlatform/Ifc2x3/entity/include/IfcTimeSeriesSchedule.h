...
namespace OpenInfraPlatform
{
	namespace Ifc2x3
	{
		...
		public:
			...
			virtual const char* classname() const { return "IfcTimeSeriesSchedule"; }
			...
			// IfcTimeSeriesSchedule -----------------------------------------------------------
			// attributes:
			std::vector<shared_ptr<IfcDateTimeSelect> >	m_ApplicableDates;			//optional
			shared_ptr<IfcTimeSeriesScheduleTypeEnum>	m_TimeSeriesScheduleType;
			shared_ptr<IfcTimeSeries>					m_TimeSeries;
		};
