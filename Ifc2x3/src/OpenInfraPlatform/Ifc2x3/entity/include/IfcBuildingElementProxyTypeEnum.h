...
namespace OpenInfraPlatform
{
	namespace Ifc2x3
	{
		// TYPE IfcBuildingElementProxyTypeEnum = ENUMERATION OF	(USERDEFINED	,NOTDEFINED);
		class IfcBuildingElementProxyTypeEnum : public Ifc2x3AbstractEnum, public Ifc2x3Type
		{
		public:
