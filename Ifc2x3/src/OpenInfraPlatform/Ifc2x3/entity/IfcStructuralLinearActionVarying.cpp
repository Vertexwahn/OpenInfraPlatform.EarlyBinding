...
#include "include/IfcStructuralLinearActionVarying.h"
...
namespace OpenInfraPlatform
{
	namespace Ifc2x3
	{
		...
		IfcStructuralLinearActionVarying::IfcStructuralLinearActionVarying() { m_entity_enum = IFCSTRUCTURALLINEARACTIONVARYING; }
		IfcStructuralLinearActionVarying::IfcStructuralLinearActionVarying( int id ) { m_id = id; m_entity_enum = IFCSTRUCTURALLINEARACTIONVARYING; }
		IfcStructuralLinearActionVarying::~IfcStructuralLinearActionVarying() {}

		// method setEntity takes over all attributes from another instance of the class
		void IfcStructuralLinearActionVarying::setEntity( shared_ptr<Ifc2x3Entity> other_entity )
		{
			shared_ptr<IfcStructuralLinearActionVarying> other = dynamic_pointer_cast<IfcStructuralLinearActionVarying>(other_entity);
			if( !other) { return; }
		...
		void IfcStructuralLinearActionVarying::getStepLine( std::stringstream& stream ) const
		{
			stream << "#" << m_id << "=IFCSTRUCTURALLINEARACTIONVARYING" << "(";
		...
		void IfcStructuralLinearActionVarying::getStepParameter( std::stringstream& stream, bool ) const { stream << "#" << m_id; }
		void IfcStructuralLinearActionVarying::readStepData( std::vector<std::string>& args, const std::map<int,shared_ptr<Ifc2x3Entity> >& map )
		{
			const int num_args = (int)args.size();
			if( num_args<14 ){ std::stringstream strserr; strserr << "Wrong parameter count for entity IfcStructuralLinearActionVarying, expecting 14, having " << num_args << ". Object id: " << getId() << std::endl; throw Ifc2x3Exception( strserr.str().c_str() ); }
			#ifdef _DEBUG
			if( num_args>14 ){ std::cout << "Wrong parameter count for entity IfcStructuralLinearActionVarying, expecting 14, having " << num_args << ". Object id: " << getId() << std::endl; }
			#endif
		...
		void IfcStructuralLinearActionVarying::setInverseCounterparts( shared_ptr<Ifc2x3Entity> ptr_self_entity )
		{
			IfcStructuralLinearAction::setInverseCounterparts( ptr_self_entity );
		}
		void IfcStructuralLinearActionVarying::unlinkSelf()
		{
			IfcStructuralLinearAction::unlinkSelf();
		}
