...
namespace OpenInfraPlatform
{
	namespace Ifc2x3
	{
		...
		void IfcReinforcementDefinitionProperties::setEntity( shared_ptr<Ifc2x3Entity> other_entity )
		{
		...
		void IfcReinforcementDefinitionProperties::setInverseCounterparts( shared_ptr<Ifc2x3Entity> ptr_self_entity )
		{
