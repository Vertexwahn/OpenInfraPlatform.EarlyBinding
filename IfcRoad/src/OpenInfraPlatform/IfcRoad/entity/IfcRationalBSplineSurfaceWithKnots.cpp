...
namespace OpenInfraPlatform
{
	namespace IfcRoad
	{
		...
		void IfcRationalBSplineSurfaceWithKnots::setEntity( shared_ptr<IfcRoadEntity> other_entity )
		{
		...
		void IfcRationalBSplineSurfaceWithKnots::setInverseCounterparts( shared_ptr<IfcRoadEntity> ptr_self_entity )
		{
