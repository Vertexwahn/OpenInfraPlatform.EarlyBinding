...
namespace OpenInfraPlatform
{
	namespace IfcRoad
	{
		...
		void IfcRelReferencedInSpatialStructure::setEntity( shared_ptr<IfcRoadEntity> other_entity )
		{
		...
		void IfcRelReferencedInSpatialStructure::setInverseCounterparts( shared_ptr<IfcRoadEntity> ptr_self_entity )
		{
			...
			if( !ptr_self ) { throw IfcRoadException( "IfcRelReferencedInSpatialStructure::setInverseCounterparts: type mismatch" ); }
