...
namespace OpenInfraPlatform
{
	namespace IfcRoad
	{
		class IfcProductRepresentationSelect : public IfcRoadAbstractSelect
		{
		public:
			...
			static shared_ptr<IfcProductRepresentationSelect> readStepData( std::string& arg, const std::map<int,shared_ptr<IfcRoadEntity> >& map );
		};
