...
namespace OpenInfraPlatform
{
	namespace IfcRoad
	{
		class IfcSizeSelect : public IfcRoadAbstractSelect
		{
		public:
			IfcSizeSelect();
			~IfcSizeSelect();
			...
			static shared_ptr<IfcSizeSelect> readStepData( std::string& arg, const std::map<int,shared_ptr<IfcRoadEntity> >& map );
		};
