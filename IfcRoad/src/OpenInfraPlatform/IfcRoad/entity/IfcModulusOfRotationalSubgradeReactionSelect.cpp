...
namespace OpenInfraPlatform
{
	namespace IfcRoad
	{
		...
		IfcModulusOfRotationalSubgradeReactionSelect::~IfcModulusOfRotationalSubgradeReactionSelect() {}
		shared_ptr<IfcModulusOfRotationalSubgradeReactionSelect> IfcModulusOfRotationalSubgradeReactionSelect::readStepData( std::string& arg, const std::map<int,shared_ptr<IfcRoadEntity> >& map )
		{
			// Read SELECT TYPE
