...
namespace OpenInfraPlatform
{
	namespace IfcBridge
	{
		...
		IfcAxis2Placement::~IfcAxis2Placement() {}
		shared_ptr<IfcAxis2Placement> IfcAxis2Placement::readStepData( std::string& arg, const std::map<int,shared_ptr<IfcBridgeEntity> >& map )
		{
			// Read SELECT TYPE
			...
			else
			{
				...
				std::stringstream strs;
				strs << "unhandled inline argument: " << arg << " in function IFC2X4::IfcAxis2Placement::readStepData" << std::endl;
				throw IfcBridgeException( strs.str() );
			}
			return shared_ptr<IfcAxis2Placement>();
		}
