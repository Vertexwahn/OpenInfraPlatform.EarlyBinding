...
namespace OpenInfraPlatform
{
	namespace IfcBridge
	{
		...
		void IfcComplexPropertyTemplate::setEntity( shared_ptr<IfcBridgeEntity> other_entity )
		{
		...
		void IfcComplexPropertyTemplate::setInverseCounterparts( shared_ptr<IfcBridgeEntity> ptr_self_entity )
		{
			...
			if( !ptr_self ) { throw IfcBridgeException( "IfcComplexPropertyTemplate::setInverseCounterparts: type mismatch" ); }
