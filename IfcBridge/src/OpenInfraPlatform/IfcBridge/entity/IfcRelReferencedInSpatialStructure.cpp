...
namespace OpenInfraPlatform
{
	namespace IfcBridge
	{
		...
		void IfcRelReferencedInSpatialStructure::setEntity( shared_ptr<IfcBridgeEntity> other_entity )
		{
		...
		void IfcRelReferencedInSpatialStructure::setInverseCounterparts( shared_ptr<IfcBridgeEntity> ptr_self_entity )
		{
			...
			if( !ptr_self ) { throw IfcBridgeException( "IfcRelReferencedInSpatialStructure::setInverseCounterparts: type mismatch" ); }
