...
namespace OpenInfraPlatform
{
	namespace IfcBridge
	{
		...
		//ENTITY
		class IfcBridgeContactElement : public IfcCivilElementPart
		{
		public:
			IfcBridgeContactElement();
			IfcBridgeContactElement( int id );
			~IfcBridgeContactElement();
			...
			virtual const char* classname() const { return "IfcBridgeContactElement"; }
			...
			// IfcBridgeContactElement -----------------------------------------------------------
			// attributes:
			shared_ptr<IfcBridgeContactType>				m_ContactType;
		};
