...
namespace OpenInfraPlatform
{
	namespace IfcBridge
	{
		class IfcModulusOfSubgradeReactionSelect : public IfcBridgeAbstractSelect
		{
		public:
			...
			static shared_ptr<IfcModulusOfSubgradeReactionSelect> readStepData( std::string& arg, const std::map<int,shared_ptr<IfcBridgeEntity> >& map );
		};
