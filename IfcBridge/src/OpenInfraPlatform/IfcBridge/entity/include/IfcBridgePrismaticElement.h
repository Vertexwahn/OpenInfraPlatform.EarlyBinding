...
namespace OpenInfraPlatform
{
	namespace IfcBridge
	{
		...
		//ENTITY
		class IfcBridgePrismaticElement : public IfcBridgeElement
		{
		public:
			IfcBridgePrismaticElement();
			IfcBridgePrismaticElement( int id );
			~IfcBridgePrismaticElement();
			...
			virtual const char* classname() const { return "IfcBridgePrismaticElement"; }
			...
			// IfcBridgePrismaticElement -----------------------------------------------------------
			// attributes:
			shared_ptr<IfcBridgePrismaticElementType>	m_PredefinedType;			//optional
		};
