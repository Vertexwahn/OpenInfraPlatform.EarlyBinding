...
namespace OpenInfraPlatform
{
	namespace IfcBridge
	{
		class IfcPresentationStyleSelect : public IfcBridgeAbstractSelect
		{
		public:
			...
			static shared_ptr<IfcPresentationStyleSelect> readStepData( std::string& arg, const std::map<int,shared_ptr<IfcBridgeEntity> >& map );
		};
