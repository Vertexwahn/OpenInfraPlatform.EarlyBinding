...
namespace OpenInfraPlatform
{
	namespace IfcBridge
	{
		...
		//ENTITY
		class IfcBridgeSegment : public IfcBridgeElement
		{
		public:
			IfcBridgeSegment();
			IfcBridgeSegment( int id );
			~IfcBridgeSegment();
			...
			virtual const char* classname() const { return "IfcBridgeSegment"; }
			...
			// IfcBridgeSegment -----------------------------------------------------------
			// attributes:
			shared_ptr<IfcBridgeSegmentType>					m_SegmentType;
			std::vector<shared_ptr<IfcCivilElementPart> >	m_SegmentParts;
		};
