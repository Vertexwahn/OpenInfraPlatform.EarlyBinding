...
namespace OpenInfraPlatform
{
	namespace IfcBridge
	{
		...
		class IfcModulusOfRotationalSubgradeReactionMeasure : public IfcDerivedMeasureValue, public IfcModulusOfRotationalSubgradeReactionSelect, public IfcBridgeType
		{
		public:
