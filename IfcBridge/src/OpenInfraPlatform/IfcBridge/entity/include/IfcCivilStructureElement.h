...
namespace OpenInfraPlatform
{
	...
	{
		//ENTITY
		class IfcCivilStructureElement : public IfcSpatialStructureElement
		{
		public:
			IfcCivilStructureElement();
			IfcCivilStructureElement( int id );
			~IfcCivilStructureElement();
			...
			virtual const char* classname() const { return "IfcCivilStructureElement"; }
