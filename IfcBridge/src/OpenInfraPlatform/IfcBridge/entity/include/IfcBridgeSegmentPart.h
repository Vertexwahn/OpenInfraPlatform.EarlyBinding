...
namespace OpenInfraPlatform
{
	namespace IfcBridge
	{
		...
		//ENTITY
		class IfcBridgeSegmentPart : public IfcCivilElementPart
		{
		public:
			IfcBridgeSegmentPart();
			IfcBridgeSegmentPart( int id );
			~IfcBridgeSegmentPart();
			...
			virtual const char* classname() const { return "IfcBridgeSegmentPart"; }
			...
			// IfcCivilElementPart -----------------------------------------------------------
			// inverse attributes:
			//  weak_ptr<IfcBridgeSegment>					m_ContainedInSegment_inverse;

			// IfcBridgeSegmentPart -----------------------------------------------------------
			// attributes:
			shared_ptr<IfcBridgeSubPartType>				m_SubPartType;
			shared_ptr<IfcBridgeMechanicalRoleType>		m_MechanicalRole;
		};
