...
namespace OpenInfraPlatform
{
	namespace IfcBridge
	{
		class IfcSizeSelect : public IfcBridgeAbstractSelect
		{
		public:
			IfcSizeSelect();
			~IfcSizeSelect();
			...
			static shared_ptr<IfcSizeSelect> readStepData( std::string& arg, const std::map<int,shared_ptr<IfcBridgeEntity> >& map );
		};
