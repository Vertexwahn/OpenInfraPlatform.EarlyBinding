...
namespace OpenInfraPlatform
{
	namespace IfcBridge
	{
		...
		//ENTITY
		class IfcBridgeStructureElement : public IfcCivilStructureElement
		{
		public:
			IfcBridgeStructureElement();
			IfcBridgeStructureElement( int id );
			~IfcBridgeStructureElement();
			...
			virtual const char* classname() const { return "IfcBridgeStructureElement"; }
