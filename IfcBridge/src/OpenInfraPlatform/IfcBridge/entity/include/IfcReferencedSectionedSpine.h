...
namespace OpenInfraPlatform
{
	namespace IfcBridge
	{
		...
		//ENTITY
		class IfcReferencedSectionedSpine : public IfcSolidModel
		{
		public:
			IfcReferencedSectionedSpine();
			IfcReferencedSectionedSpine( int id );
			~IfcReferencedSectionedSpine();
			...
			virtual const char* classname() const { return "IfcReferencedSectionedSpine"; }
