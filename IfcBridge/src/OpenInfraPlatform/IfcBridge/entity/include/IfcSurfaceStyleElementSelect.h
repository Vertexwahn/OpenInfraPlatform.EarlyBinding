...
namespace OpenInfraPlatform
{
	namespace IfcBridge
	{
		class IfcSurfaceStyleElementSelect : public IfcBridgeAbstractSelect
		{
		public:
			...
			static shared_ptr<IfcSurfaceStyleElementSelect> readStepData( std::string& arg, const std::map<int,shared_ptr<IfcBridgeEntity> >& map );
		};
