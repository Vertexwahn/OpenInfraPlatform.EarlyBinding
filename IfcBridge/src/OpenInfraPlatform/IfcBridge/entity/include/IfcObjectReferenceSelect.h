...
namespace OpenInfraPlatform
{
	namespace IfcBridge
	{
		class IfcObjectReferenceSelect : public IfcBridgeAbstractSelect
		{
		public:
			...
			static shared_ptr<IfcObjectReferenceSelect> readStepData( std::string& arg, const std::map<int,shared_ptr<IfcBridgeEntity> >& map );
		};
