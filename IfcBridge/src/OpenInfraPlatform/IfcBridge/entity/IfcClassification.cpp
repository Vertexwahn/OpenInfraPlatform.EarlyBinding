...
namespace OpenInfraPlatform
{
	namespace IfcBridge
	{
		...
		void IfcClassification::setEntity( shared_ptr<IfcBridgeEntity> other_entity )
		{
		...
		void IfcClassification::setInverseCounterparts( shared_ptr<IfcBridgeEntity> ptr_self_entity )
		{
