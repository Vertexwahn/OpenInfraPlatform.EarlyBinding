...
namespace OpenInfraPlatform
{
	namespace IfcBridge
	{
		...
		void IfcRelConnectsPorts::setEntity( shared_ptr<IfcBridgeEntity> other_entity )
		{
		...
		void IfcRelConnectsPorts::setInverseCounterparts( shared_ptr<IfcBridgeEntity> ptr_self_entity )
		{
			IfcRelConnects::setInverseCounterparts( ptr_self_entity );
			shared_ptr<IfcRelConnectsPorts> ptr_self = dynamic_pointer_cast<IfcRelConnectsPorts>( ptr_self_entity );
			if( !ptr_self ) { throw IfcBridgeException( "IfcRelConnectsPorts::setInverseCounterparts: type mismatch" ); }
			if( m_RelatedPort )
			{
