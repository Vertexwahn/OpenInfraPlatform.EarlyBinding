...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcRelDefinesByObject -----------------------
			// attributes:
			std::vector<std::shared_ptr<IfcObject>>  m_RelatedObjects;
			std::shared_ptr<IfcObject> m_RelatingObject;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcRelDefinesByObject, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_RelatedObjects, m_RelatingObject);
