...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcRectangularPyramid -----------------------
			// attributes:
			std::shared_ptr<IfcPositiveLengthMeasure> m_XLength;
			std::shared_ptr<IfcPositiveLengthMeasure> m_YLength;
			std::shared_ptr<IfcPositiveLengthMeasure> m_Height;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcRectangularPyramid, m_Position, m_XLength, m_YLength, m_Height);
