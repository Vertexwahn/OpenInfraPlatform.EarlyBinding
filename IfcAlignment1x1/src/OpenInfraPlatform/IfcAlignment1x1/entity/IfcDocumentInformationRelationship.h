...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcDocumentInformationRelationship -----------------------
			// attributes:
			std::shared_ptr<IfcDocumentInformation> m_RelatingDocument;
			std::vector<std::shared_ptr<IfcDocumentInformation>>  m_RelatedDocuments;
			std::shared_ptr<IfcLabel> m_RelationshipType;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcDocumentInformationRelationship, m_Name, m_Description, m_RelatingDocument, m_RelatedDocuments, m_RelationshipType);
