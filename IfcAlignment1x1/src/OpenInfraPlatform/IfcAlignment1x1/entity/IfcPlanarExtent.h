...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcPlanarExtent -----------------------
			// attributes:
			std::shared_ptr<IfcLengthMeasure> m_SizeInX;
			std::shared_ptr<IfcLengthMeasure> m_SizeInY;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcPlanarExtent, m_SizeInX, m_SizeInY);
