...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcCoordinateReferenceSystem : public IfcAlignment1x1Entity, public IfcCoordinateReferenceSystemSelect
		...
		public:
			...
			std::shared_ptr<IfcIdentifier> m_GeodeticDatum;
			std::shared_ptr<IfcIdentifier> m_VerticalDatum;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcCoordinateReferenceSystem, m_Name, m_Description, m_GeodeticDatum, m_VerticalDatum);
