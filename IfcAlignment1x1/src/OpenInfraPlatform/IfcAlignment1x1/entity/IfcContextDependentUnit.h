...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcContextDependentUnit : public IfcNamedUnit, public IfcResourceObjectSelect
...
VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcContextDependentUnit, m_Dimensions, m_UnitType, m_Name);
