...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			std::shared_ptr<IfcProfileDef> m_Profile;
...
VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcMaterialProfile, m_Name, m_Description, m_Material, m_Profile, m_Priority, m_Category);
