...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcConnectionPointGeometry -----------------------
			// attributes:
			std::shared_ptr<IfcPointOrVertexPoint> m_PointOnRelatingElement;
			std::shared_ptr<IfcPointOrVertexPoint> m_PointOnRelatedElement;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcConnectionPointGeometry, m_PointOnRelatingElement, m_PointOnRelatedElement);
