...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcBlobTexture -----------------------
			// attributes:
			std::shared_ptr<IfcIdentifier> m_RasterFormat;
			std::shared_ptr<IfcBinary> m_RasterCode;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcBlobTexture, m_RepeatS, m_RepeatT, m_Mode, m_TextureTransform, m_Parameter, m_RasterFormat, m_RasterCode);
