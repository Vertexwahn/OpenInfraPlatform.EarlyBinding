...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcRelAssignsToActor -----------------------
			// attributes:
			std::shared_ptr<IfcActor> m_RelatingActor;
			std::shared_ptr<IfcActorRole> m_ActingRole;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcRelAssignsToActor, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_RelatedObjects, m_RelatedObjectsType, m_RelatingActor, m_ActingRole);
