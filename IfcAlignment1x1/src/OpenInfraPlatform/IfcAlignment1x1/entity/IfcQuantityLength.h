...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcQuantityLength -----------------------
			// attributes:
			std::shared_ptr<IfcLengthMeasure> m_LengthValue;
			std::shared_ptr<IfcLabel> m_Formula;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcQuantityLength, m_Name, m_Description, m_Unit, m_LengthValue, m_Formula);
