...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcMaterialLayer -----------------------
			// attributes:
			std::shared_ptr<IfcMaterial> m_Material;
			std::shared_ptr<IfcNonNegativeLengthMeasure> m_LayerThickness;
			std::shared_ptr<IfcLogical> m_IsVentilated;
...
VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcMaterialLayer, m_Material, m_LayerThickness, m_IsVentilated, m_Name, m_Description, m_Category, m_Priority);
