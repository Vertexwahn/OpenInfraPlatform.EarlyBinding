...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcMaterialList : public IfcAlignment1x1Entity, public IfcMaterialSelect
		...
		public:
			...
			// IfcMaterialList -----------------------
			// attributes:
			std::vector<std::shared_ptr<IfcMaterial>>  m_Materials;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcMaterialList, m_Materials);
