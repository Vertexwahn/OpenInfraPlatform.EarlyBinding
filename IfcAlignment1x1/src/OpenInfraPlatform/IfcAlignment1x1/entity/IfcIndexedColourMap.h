...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcIndexedColourMap -----------------------
			// attributes:
			std::shared_ptr<IfcTessellatedFaceSet> m_MappedTo;
			std::shared_ptr<IfcNormalisedRatioMeasure> m_Opacity;
			std::shared_ptr<IfcColourRgbList> m_Colours;
			std::vector<std::shared_ptr<IfcPositiveInteger>>  m_ColourIndex;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcIndexedColourMap, m_MappedTo, m_Opacity, m_Colours, m_ColourIndex);
