...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcPreDefinedCurveFont : public IfcPreDefinedItem, public IfcCurveStyleFontSelect
...
VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcPreDefinedCurveFont, m_Name);
