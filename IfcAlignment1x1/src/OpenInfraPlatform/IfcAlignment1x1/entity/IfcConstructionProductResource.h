...
VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcConstructionProductResource, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_ObjectType, m_Identification, m_LongDescription, m_Usage, m_BaseCosts, m_BaseQuantity, m_PredefinedType);
