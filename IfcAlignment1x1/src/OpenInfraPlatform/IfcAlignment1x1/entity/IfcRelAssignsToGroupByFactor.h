...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcRelAssignsToGroupByFactor -----------------------
			// attributes:
			std::shared_ptr<IfcRatioMeasure> m_Factor;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcRelAssignsToGroupByFactor, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_RelatedObjects, m_RelatedObjectsType, m_RelatingGroup, m_Factor);
