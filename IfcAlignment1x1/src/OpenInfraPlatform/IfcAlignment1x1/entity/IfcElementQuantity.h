...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcElementQuantity -----------------------
			// attributes:
			std::shared_ptr<IfcLabel> m_MethodOfMeasurement;
			std::vector<std::shared_ptr<IfcPhysicalQuantity>>  m_Quantities;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcElementQuantity, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_MethodOfMeasurement, m_Quantities);
