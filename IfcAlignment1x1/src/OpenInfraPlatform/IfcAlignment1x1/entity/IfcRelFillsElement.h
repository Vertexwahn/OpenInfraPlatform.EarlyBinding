...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcRelFillsElement -----------------------
			// attributes:
			std::shared_ptr<IfcOpeningElement> m_RelatingOpeningElement;
			std::shared_ptr<IfcElement> m_RelatedBuildingElement;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcRelFillsElement, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_RelatingOpeningElement, m_RelatedBuildingElement);
