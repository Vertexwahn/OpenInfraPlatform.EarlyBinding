...
VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcAlignment2DVerSegLine, m_TangentialContinuity, m_StartTag, m_EndTag, m_StartDistAlong, m_HorizontalLength, m_StartHeight, m_StartGradient);
