...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcTypeObject -----------------------
			// attributes:
			std::shared_ptr<IfcIdentifier> m_ApplicableOccurrence;
			std::vector<std::shared_ptr<IfcPropertySetDefinition>>  m_HasPropertySets;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcTypeObject, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_ApplicableOccurrence, m_HasPropertySets);
