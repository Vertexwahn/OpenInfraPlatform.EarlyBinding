...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcTimePeriod : public IfcAlignment1x1Entity
		{
		public:
			IfcTimePeriod();
			...
			// IfcTimePeriod -----------------------
			// attributes:
			std::shared_ptr<IfcTime> m_StartTime;
			std::shared_ptr<IfcTime> m_EndTime;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcTimePeriod, m_StartTime, m_EndTime);
