...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcSurfaceStyleWithTextures : public IfcPresentationItem, public IfcSurfaceStyleElementSelect
		...
		public:
			...
			// IfcSurfaceStyleWithTextures -----------------------
			// attributes:
			std::vector<std::shared_ptr<IfcSurfaceTexture>>  m_Textures;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcSurfaceStyleWithTextures, m_Textures);
