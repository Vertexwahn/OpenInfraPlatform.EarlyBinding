...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcRelReferencedInSpatialStructure -----------------------
			// attributes:
			std::vector<std::shared_ptr<IfcProduct>>  m_RelatedElements;
			std::shared_ptr<IfcSpatialElement> m_RelatingStructure;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcRelReferencedInSpatialStructure, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_RelatedElements, m_RelatingStructure);
