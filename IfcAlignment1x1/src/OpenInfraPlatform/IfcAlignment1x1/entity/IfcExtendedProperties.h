...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcExtendedProperties -----------------------
			// attributes:
			std::shared_ptr<IfcIdentifier> m_Name;
			std::shared_ptr<IfcText> m_Description;
			std::vector<std::shared_ptr<IfcProperty>>  m_Properties;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcExtendedProperties, m_Name, m_Description, m_Properties);
