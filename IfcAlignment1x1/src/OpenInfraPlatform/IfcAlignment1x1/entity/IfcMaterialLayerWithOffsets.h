...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcMaterialLayerWithOffsets -----------------------
			// attributes:
			std::shared_ptr<IfcLayerSetDirectionEnum> m_OffsetDirection;
			std::vector<std::shared_ptr<IfcLengthMeasure>>  m_OffsetValues;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcMaterialLayerWithOffsets, m_Material, m_LayerThickness, m_IsVentilated, m_Name, m_Description, m_Category, m_Priority, m_OffsetDirection, m_OffsetValues);
