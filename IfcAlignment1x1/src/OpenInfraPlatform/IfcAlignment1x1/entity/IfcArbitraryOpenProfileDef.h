...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcArbitraryOpenProfileDef -----------------------
			// attributes:
			std::shared_ptr<IfcBoundedCurve> m_Curve;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcArbitraryOpenProfileDef, m_ProfileType, m_ProfileName, m_Curve);
