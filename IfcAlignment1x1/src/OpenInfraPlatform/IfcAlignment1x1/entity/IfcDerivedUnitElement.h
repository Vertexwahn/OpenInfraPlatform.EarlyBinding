...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcDerivedUnitElement : public IfcAlignment1x1Entity
		{
		public:
			...
			// IfcDerivedUnitElement -----------------------
			// attributes:
			std::shared_ptr<IfcNamedUnit> m_Unit;
			int m_Exponent;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcDerivedUnitElement, m_Unit, m_Exponent);
