...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcBooleanResult : public IfcGeometricRepresentationItem, public IfcBooleanOperand
, public IfcCsgSelect
		...
		public:
			...
			// IfcBooleanResult -----------------------
			// attributes:
			std::shared_ptr<IfcBooleanOperator> m_Operator;
			std::shared_ptr<IfcBooleanOperand> m_FirstOperand;
			std::shared_ptr<IfcBooleanOperand> m_SecondOperand;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcBooleanResult, m_Operator, m_FirstOperand, m_SecondOperand);
