...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcPresentationStyleAssignment : public IfcAlignment1x1Entity, public IfcStyleAssignmentSelect
		...
		public:
			...
			// IfcPresentationStyleAssignment -----------------------
			// attributes:
			std::vector<std::shared_ptr<IfcPresentationStyleSelect>>  m_Styles;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcPresentationStyleAssignment, m_Styles);
