...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcBoolean;
		// ENTITY IfcGridAxis
		class IfcGridAxis : public IfcAlignment1x1Entity
		{
		public:
			IfcGridAxis();
			IfcGridAxis( int id );
			...
			// IfcGridAxis -----------------------
			// attributes:
			std::shared_ptr<IfcLabel> m_AxisTag;
			std::shared_ptr<IfcCurve> m_AxisCurve;
			std::shared_ptr<IfcBoolean> m_SameSense;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcGridAxis, m_AxisTag, m_AxisCurve, m_SameSense);
