...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcBoundaryFaceCondition -----------------------
			// attributes:
			std::shared_ptr<IfcModulusOfSubgradeReactionSelect> m_TranslationalStiffnessByAreaX;
			std::shared_ptr<IfcModulusOfSubgradeReactionSelect> m_TranslationalStiffnessByAreaY;
			std::shared_ptr<IfcModulusOfSubgradeReactionSelect> m_TranslationalStiffnessByAreaZ;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcBoundaryFaceCondition, m_Name, m_TranslationalStiffnessByAreaX, m_TranslationalStiffnessByAreaY, m_TranslationalStiffnessByAreaZ);
