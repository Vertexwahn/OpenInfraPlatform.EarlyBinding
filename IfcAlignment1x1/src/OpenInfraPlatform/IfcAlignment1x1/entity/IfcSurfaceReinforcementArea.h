...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcSurfaceReinforcementArea -----------------------
			// attributes:
			std::vector<std::shared_ptr<IfcLengthMeasure>>  m_SurfaceReinforcement1;
			std::vector<std::shared_ptr<IfcLengthMeasure>>  m_SurfaceReinforcement2;
			std::shared_ptr<IfcRatioMeasure> m_ShearReinforcement;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcSurfaceReinforcementArea, m_Name, m_SurfaceReinforcement1, m_SurfaceReinforcement2, m_ShearReinforcement);
