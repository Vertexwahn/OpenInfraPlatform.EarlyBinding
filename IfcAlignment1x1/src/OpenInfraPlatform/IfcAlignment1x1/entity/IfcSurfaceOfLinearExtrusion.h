...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcSurfaceOfLinearExtrusion -----------------------
			// attributes:
			std::shared_ptr<IfcDirection> m_ExtrudedDirection;
			std::shared_ptr<IfcLengthMeasure> m_Depth;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcSurfaceOfLinearExtrusion, m_SweptCurve, m_Position, m_ExtrudedDirection, m_Depth);
