...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			std::shared_ptr<IfcSurface> m_ReferenceSurface;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcSurfaceCurveSweptAreaSolid, m_SweptArea, m_Position, m_Directrix, m_StartParam, m_EndParam, m_ReferenceSurface);
