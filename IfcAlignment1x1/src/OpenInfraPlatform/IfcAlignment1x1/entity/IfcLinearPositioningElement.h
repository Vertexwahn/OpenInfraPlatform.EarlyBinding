...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			virtual const char* classname() const { return "IfcLinearPositioningElement"; }

			// IfcLinearPositioningElement -----------------------
			// attributes:
			std::shared_ptr<IfcCurve> m_Axis;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcLinearPositioningElement, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_ObjectType, m_ObjectPlacement, m_Representation, m_Axis);
