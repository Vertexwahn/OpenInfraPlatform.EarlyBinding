...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcPersonAndOrganization : public IfcAlignment1x1Entity, public IfcActorSelect
...
, public IfcResourceObjectSelect
		...
		public:
			...
			// IfcPersonAndOrganization -----------------------
			// attributes:
			std::shared_ptr<IfcPerson> m_ThePerson;
			std::shared_ptr<IfcOrganization> m_TheOrganization;
			std::vector<std::shared_ptr<IfcActorRole>>  m_Roles;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcPersonAndOrganization, m_ThePerson, m_TheOrganization, m_Roles);
