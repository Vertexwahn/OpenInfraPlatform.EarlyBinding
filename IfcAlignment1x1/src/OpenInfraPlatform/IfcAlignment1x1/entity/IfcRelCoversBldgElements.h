...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			std::vector<std::shared_ptr<IfcCovering>>  m_RelatedCoverings;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcRelCoversBldgElements, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_RelatingBuildingElement, m_RelatedCoverings);
