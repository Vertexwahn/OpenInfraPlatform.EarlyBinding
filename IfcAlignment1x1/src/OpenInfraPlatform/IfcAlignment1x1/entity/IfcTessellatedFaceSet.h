...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcTessellatedFaceSet : public IfcTessellatedItem, public IfcBooleanOperand
		...
		public:
			...
			// IfcTessellatedFaceSet -----------------------
			// attributes:
			std::shared_ptr<IfcCartesianPointList3D> m_Coordinates;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcTessellatedFaceSet, m_Coordinates);
