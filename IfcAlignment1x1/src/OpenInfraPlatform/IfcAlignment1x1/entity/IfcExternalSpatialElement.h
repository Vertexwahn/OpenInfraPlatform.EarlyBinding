...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcExternalSpatialElement : public IfcExternalSpatialStructureElement, public IfcSpaceBoundarySelect
		...
		public:
			...
			// IfcExternalSpatialElement -----------------------
			// attributes:
			std::shared_ptr<IfcExternalSpatialElementTypeEnum> m_PredefinedType;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcExternalSpatialElement, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_ObjectType, m_ObjectPlacement, m_Representation, m_LongName, m_PredefinedType);
