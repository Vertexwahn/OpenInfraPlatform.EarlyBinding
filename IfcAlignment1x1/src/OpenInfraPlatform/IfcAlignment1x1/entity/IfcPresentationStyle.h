...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcPresentationStyle : public IfcAlignment1x1Entity, public IfcStyleAssignmentSelect
...
VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcPresentationStyle, m_Name);
