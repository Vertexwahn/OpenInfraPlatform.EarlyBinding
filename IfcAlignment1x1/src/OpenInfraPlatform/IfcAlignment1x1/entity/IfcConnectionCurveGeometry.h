...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcConnectionCurveGeometry -----------------------
			// attributes:
			std::shared_ptr<IfcCurveOrEdgeCurve> m_CurveOnRelatingElement;
			std::shared_ptr<IfcCurveOrEdgeCurve> m_CurveOnRelatedElement;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcConnectionCurveGeometry, m_CurveOnRelatingElement, m_CurveOnRelatedElement);
