...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcCompositeProfileDef -----------------------
			// attributes:
			std::vector<std::shared_ptr<IfcProfileDef>>  m_Profiles;
			std::shared_ptr<IfcLabel> m_Label;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcCompositeProfileDef, m_ProfileType, m_ProfileName, m_Profiles, m_Label);
