...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcStructuralLoadCase -----------------------
			// attributes:
			std::vector<std::shared_ptr<IfcRatioMeasure>>  m_SelfWeightCoefficients;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcStructuralLoadCase, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_ObjectType, m_PredefinedType, m_ActionType, m_ActionSource, m_Coefficient, m_Purpose, m_SelfWeightCoefficients);
