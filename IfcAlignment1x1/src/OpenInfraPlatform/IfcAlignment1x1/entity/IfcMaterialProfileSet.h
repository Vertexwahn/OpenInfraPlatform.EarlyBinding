...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			std::vector<std::shared_ptr<IfcMaterialProfile>>  m_MaterialProfiles;
			std::shared_ptr<IfcCompositeProfileDef> m_CompositeProfile;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcMaterialProfileSet, m_Name, m_Description, m_MaterialProfiles, m_CompositeProfile);
