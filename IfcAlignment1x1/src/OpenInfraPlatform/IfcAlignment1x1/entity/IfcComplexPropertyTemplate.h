...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcComplexPropertyTemplate -----------------------
			// attributes:
			std::shared_ptr<IfcLabel> m_UsageName;
			std::shared_ptr<IfcComplexPropertyTemplateTypeEnum> m_TemplateType;
			std::vector<std::shared_ptr<IfcPropertyTemplate>>  m_HasPropertyTemplates;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcComplexPropertyTemplate, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_UsageName, m_TemplateType, m_HasPropertyTemplates);
