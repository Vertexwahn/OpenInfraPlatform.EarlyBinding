...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcComplexProperty -----------------------
			// attributes:
			std::shared_ptr<IfcIdentifier> m_UsageName;
			std::vector<std::shared_ptr<IfcProperty>>  m_HasProperties;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcComplexProperty, m_Name, m_Description, m_UsageName, m_HasProperties);
