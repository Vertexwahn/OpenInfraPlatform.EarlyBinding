...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcRelAssignsToControl -----------------------
			// attributes:
			std::shared_ptr<IfcControl> m_RelatingControl;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcRelAssignsToControl, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_RelatedObjects, m_RelatedObjectsType, m_RelatingControl);
