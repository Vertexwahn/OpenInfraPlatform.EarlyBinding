...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcPresentationLayerWithStyle -----------------------
			// attributes:
			std::shared_ptr<IfcLogical> m_LayerOn;
			std::shared_ptr<IfcLogical> m_LayerFrozen;
			std::shared_ptr<IfcLogical> m_LayerBlocked;
			std::vector<std::shared_ptr<IfcPresentationStyle>>  m_LayerStyles;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcPresentationLayerWithStyle, m_Name, m_Description, m_AssignedItems, m_Identifier, m_LayerOn, m_LayerFrozen, m_LayerBlocked, m_LayerStyles);
