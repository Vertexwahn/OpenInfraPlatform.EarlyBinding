...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcText;
		// ENTITY IfcResource
		class IfcResource : public IfcObject, public IfcResourceSelect
...
VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcResource, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_ObjectType, m_Identification, m_LongDescription);
