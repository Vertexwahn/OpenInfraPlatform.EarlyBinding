...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcIrregularTimeSeriesValue : public IfcAlignment1x1Entity
		{
		public:
			...
			// IfcIrregularTimeSeriesValue -----------------------
			// attributes:
			std::shared_ptr<IfcDateTime> m_TimeStamp;
			std::vector<std::shared_ptr<IfcValue>>  m_ListValues;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcIrregularTimeSeriesValue, m_TimeStamp, m_ListValues);
