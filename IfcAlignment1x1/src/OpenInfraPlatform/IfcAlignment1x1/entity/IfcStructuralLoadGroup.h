...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcStructuralLoadGroup -----------------------
			// attributes:
			std::shared_ptr<IfcLoadGroupTypeEnum> m_PredefinedType;
			std::shared_ptr<IfcActionTypeEnum> m_ActionType;
			std::shared_ptr<IfcActionSourceTypeEnum> m_ActionSource;
			std::shared_ptr<IfcRatioMeasure> m_Coefficient;
			std::shared_ptr<IfcLabel> m_Purpose;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcStructuralLoadGroup, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_ObjectType, m_PredefinedType, m_ActionType, m_ActionSource, m_Coefficient, m_Purpose);
