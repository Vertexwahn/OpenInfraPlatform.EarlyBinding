...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcTypeProcess : public IfcTypeObject, public IfcProcessSelect
		...
		public:
			...
			std::shared_ptr<IfcLabel> m_ProcessType;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcTypeProcess, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_ApplicableOccurrence, m_HasPropertySets, m_Identification, m_LongDescription, m_ProcessType);
