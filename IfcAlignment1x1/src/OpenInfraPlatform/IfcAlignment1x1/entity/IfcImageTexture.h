...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcImageTexture -----------------------
			// attributes:
			std::shared_ptr<IfcURIReference> m_URLReference;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcImageTexture, m_RepeatS, m_RepeatT, m_Mode, m_TextureTransform, m_Parameter, m_URLReference);
