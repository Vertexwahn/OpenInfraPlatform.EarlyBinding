...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			std::vector<std::shared_ptr<IfcApproval>>  m_RelatedApprovals;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcApprovalRelationship, m_Name, m_Description, m_RelatingApproval, m_RelatedApprovals);
