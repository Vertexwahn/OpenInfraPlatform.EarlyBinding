...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			virtual const char* classname() const { return "IfcAlignment"; }

			// IfcAlignment -----------------------
			// attributes:
			std::shared_ptr<IfcAlignmentTypeEnum> m_PredefinedType;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcAlignment, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_ObjectType, m_ObjectPlacement, m_Representation, m_Axis, m_PredefinedType);
