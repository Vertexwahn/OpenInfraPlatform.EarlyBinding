...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcRevolvedAreaSolid -----------------------
			// attributes:
			std::shared_ptr<IfcAxis1Placement> m_Axis;
			std::shared_ptr<IfcPlaneAngleMeasure> m_Angle;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcRevolvedAreaSolid, m_SweptArea, m_Position, m_Axis, m_Angle);
