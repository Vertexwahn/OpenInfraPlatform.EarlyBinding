...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcTriangulatedIrregularNetwork -----------------------
			// attributes:
			std::vector<std::shared_ptr<IfcInteger>>  m_Flags;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcTriangulatedIrregularNetwork, m_Coordinates, m_Normals, m_Closed, m_CoordIndex, m_PnIndex, m_Flags);
