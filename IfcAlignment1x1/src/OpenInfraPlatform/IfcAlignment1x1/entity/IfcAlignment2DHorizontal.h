...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcAlignment2DHorizontal : public IfcAlignment1x1Entity
		{
		public:
			...
			std::vector<std::shared_ptr<IfcAlignment2DHorizontalSegment>>  m_Segments;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcAlignment2DHorizontal, m_StartDistAlong, m_Segments);
