...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcProfileProperties -----------------------
			// attributes:
			std::shared_ptr<IfcProfileDef> m_ProfileDefinition;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcProfileProperties, m_Name, m_Description, m_Properties, m_ProfileDefinition);
