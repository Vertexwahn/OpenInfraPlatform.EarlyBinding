...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			std::shared_ptr<IfcBoundedCurve> m_PolygonalBoundary;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcPolygonalBoundedHalfSpace, m_BaseSurface, m_AgreementFlag, m_Position, m_PolygonalBoundary);
