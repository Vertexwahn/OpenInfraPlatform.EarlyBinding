...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcSchedulingTime : public IfcAlignment1x1Entity
		{
		public:
			IfcSchedulingTime();
...
VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcSchedulingTime, m_Name, m_DataOrigin, m_UserDefinedDataOrigin);
