...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcRelDefinesByTemplate -----------------------
			// attributes:
			std::vector<std::shared_ptr<IfcPropertySetDefinition>>  m_RelatedPropertySets;
			std::shared_ptr<IfcPropertySetTemplate> m_RelatingTemplate;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcRelDefinesByTemplate, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_RelatedPropertySets, m_RelatingTemplate);
