...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcMaterialClassificationRelationship : public IfcAlignment1x1Entity
		{
		public:
			...
			// IfcMaterialClassificationRelationship -----------------------
			// attributes:
			std::vector<std::shared_ptr<IfcClassificationSelect>>  m_MaterialClassifications;
			std::shared_ptr<IfcMaterial> m_ClassifiedMaterial;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcMaterialClassificationRelationship, m_MaterialClassifications, m_ClassifiedMaterial);
