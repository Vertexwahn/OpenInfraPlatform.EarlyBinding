...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcTypeResource : public IfcTypeObject, public IfcResourceSelect
		...
		public:
			...
			std::shared_ptr<IfcText> m_LongDescription;
			std::shared_ptr<IfcLabel> m_ResourceType;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcTypeResource, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_ApplicableOccurrence, m_HasPropertySets, m_Identification, m_LongDescription, m_ResourceType);
