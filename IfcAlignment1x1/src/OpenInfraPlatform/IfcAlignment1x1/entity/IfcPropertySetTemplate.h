...
VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcPropertySetTemplate, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_TemplateType, m_ApplicableEntity, m_HasPropertyTemplates);
