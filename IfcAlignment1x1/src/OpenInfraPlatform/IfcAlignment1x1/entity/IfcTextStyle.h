...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcBoolean;
		// ENTITY IfcTextStyle
		class IfcTextStyle : public IfcPresentationStyle, public IfcPresentationStyleSelect
		...
		public:
			...
			// IfcTextStyle -----------------------
			// attributes:
			std::shared_ptr<IfcTextStyleForDefinedFont> m_TextCharacterAppearance;
			std::shared_ptr<IfcTextStyleTextModel> m_TextStyle;
			std::shared_ptr<IfcTextFontSelect> m_TextFontStyle;
			std::shared_ptr<IfcBoolean> m_ModelOrDraughting;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcTextStyle, m_Name, m_TextCharacterAppearance, m_TextStyle, m_TextFontStyle, m_ModelOrDraughting);
