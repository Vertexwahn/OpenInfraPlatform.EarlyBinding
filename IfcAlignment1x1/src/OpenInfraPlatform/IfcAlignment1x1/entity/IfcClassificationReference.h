...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcClassificationReference : public IfcExternalReference, public IfcClassificationReferenceSelect
, public IfcClassificationSelect
		...
		public:
			...
			// IfcClassificationReference -----------------------
			// attributes:
			std::shared_ptr<IfcClassificationReferenceSelect> m_ReferencedSource;
			std::shared_ptr<IfcText> m_Description;
			std::shared_ptr<IfcIdentifier> m_Sort;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcClassificationReference, m_Location, m_Identification, m_Name, m_ReferencedSource, m_Description, m_Sort);
