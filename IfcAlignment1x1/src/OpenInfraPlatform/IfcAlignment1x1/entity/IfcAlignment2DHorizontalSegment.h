...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcAlignment2DHorizontalSegment -----------------------
			// attributes:
			std::shared_ptr<IfcCurveSegment2D> m_CurveGeometry;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcAlignment2DHorizontalSegment, m_TangentialContinuity, m_StartTag, m_EndTag, m_CurveGeometry);
