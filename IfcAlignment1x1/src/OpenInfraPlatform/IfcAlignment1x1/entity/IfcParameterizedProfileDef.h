...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcParameterizedProfileDef -----------------------
			// attributes:
			std::shared_ptr<IfcAxis2Placement2D> m_Position;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcParameterizedProfileDef, m_ProfileType, m_ProfileName, m_Position);
