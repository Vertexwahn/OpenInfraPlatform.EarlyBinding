...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcRationalBSplineSurfaceWithKnots -----------------------
			// attributes:
			std::vector<std::vector<std::shared_ptr<IfcReal>>>  m_WeightsData;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcRationalBSplineSurfaceWithKnots, m_UDegree, m_VDegree, m_ControlPointsList, m_SurfaceForm, m_UClosed, m_VClosed, m_SelfIntersect, m_UMultiplicities, m_VMultiplicities, m_UKnots, m_VKnots, m_KnotSpec, m_WeightsData);
