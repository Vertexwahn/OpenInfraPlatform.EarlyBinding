...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			std::shared_ptr<IfcApproval> m_RelatingApproval;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcResourceApprovalRelationship, m_Name, m_Description, m_RelatedResourceObjects, m_RelatingApproval);
