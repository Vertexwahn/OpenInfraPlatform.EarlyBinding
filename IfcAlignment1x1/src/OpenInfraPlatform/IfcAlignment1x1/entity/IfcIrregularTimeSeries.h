...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcIrregularTimeSeries -----------------------
			// attributes:
			std::vector<std::shared_ptr<IfcIrregularTimeSeriesValue>>  m_Values;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcIrregularTimeSeries, m_Name, m_Description, m_StartTime, m_EndTime, m_TimeSeriesDataType, m_DataOrigin, m_UserDefinedDataOrigin, m_Unit, m_Values);
