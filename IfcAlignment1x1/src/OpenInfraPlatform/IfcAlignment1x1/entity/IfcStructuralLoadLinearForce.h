...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcStructuralLoadLinearForce -----------------------
			// attributes:
			std::shared_ptr<IfcLinearForceMeasure> m_LinearForceX;
			std::shared_ptr<IfcLinearForceMeasure> m_LinearForceY;
			std::shared_ptr<IfcLinearForceMeasure> m_LinearForceZ;
			std::shared_ptr<IfcLinearMomentMeasure> m_LinearMomentX;
			std::shared_ptr<IfcLinearMomentMeasure> m_LinearMomentY;
			std::shared_ptr<IfcLinearMomentMeasure> m_LinearMomentZ;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcStructuralLoadLinearForce, m_Name, m_LinearForceX, m_LinearForceY, m_LinearForceZ, m_LinearMomentX, m_LinearMomentY, m_LinearMomentZ);
