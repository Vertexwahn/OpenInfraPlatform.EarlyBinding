...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcProfileDef : public IfcAlignment1x1Entity, public IfcResourceObjectSelect
		...
		public:
			...
			// IfcProfileDef -----------------------
			// attributes:
			std::shared_ptr<IfcProfileTypeEnum> m_ProfileType;
			std::shared_ptr<IfcLabel> m_ProfileName;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcProfileDef, m_ProfileType, m_ProfileName);
