...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcLibraryReference : public IfcExternalReference, public IfcLibrarySelect
		...
		public:
			...
			std::shared_ptr<IfcLanguageId> m_Language;
			std::shared_ptr<IfcLibraryInformation> m_ReferencedLibrary;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcLibraryReference, m_Location, m_Identification, m_Name, m_Description, m_Language, m_ReferencedLibrary);
