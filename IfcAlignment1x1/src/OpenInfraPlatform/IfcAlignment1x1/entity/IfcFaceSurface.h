...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcFaceSurface : public IfcFace, public IfcSurfaceOrFaceSurface
		...
		public:
			...
			// IfcFaceSurface -----------------------
			// attributes:
			std::shared_ptr<IfcSurface> m_FaceSurface;
			std::shared_ptr<IfcBoolean> m_SameSense;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcFaceSurface, m_Bounds, m_FaceSurface, m_SameSense);
