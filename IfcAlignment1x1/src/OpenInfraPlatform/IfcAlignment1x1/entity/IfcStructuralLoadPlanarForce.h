...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcStructuralLoadPlanarForce -----------------------
			// attributes:
			std::shared_ptr<IfcPlanarForceMeasure> m_PlanarForceX;
			std::shared_ptr<IfcPlanarForceMeasure> m_PlanarForceY;
			std::shared_ptr<IfcPlanarForceMeasure> m_PlanarForceZ;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcStructuralLoadPlanarForce, m_Name, m_PlanarForceX, m_PlanarForceY, m_PlanarForceZ);
