...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcSectionedSpine -----------------------
			// attributes:
			std::shared_ptr<IfcCompositeCurve> m_SpineCurve;
			std::vector<std::shared_ptr<IfcProfileDef>>  m_CrossSections;
			std::vector<std::shared_ptr<IfcAxis2Placement3D>>  m_CrossSectionPositions;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcSectionedSpine, m_SpineCurve, m_CrossSections, m_CrossSectionPositions);
