...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcPropertyEnumeratedValue -----------------------
			// attributes:
			std::vector<std::shared_ptr<IfcValue>>  m_EnumerationValues;
			std::shared_ptr<IfcPropertyEnumeration> m_EnumerationReference;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcPropertyEnumeratedValue, m_Name, m_Description, m_EnumerationValues, m_EnumerationReference);
