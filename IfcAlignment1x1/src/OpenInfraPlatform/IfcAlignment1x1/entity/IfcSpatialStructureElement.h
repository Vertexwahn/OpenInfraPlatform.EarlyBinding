...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcSpatialStructureElement -----------------------
			// attributes:
			std::shared_ptr<IfcElementCompositionEnum> m_CompositionType;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcSpatialStructureElement, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_ObjectType, m_ObjectPlacement, m_Representation, m_LongName, m_CompositionType);
