...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcPermeableCoveringProperties -----------------------
			// attributes:
			std::shared_ptr<IfcPermeableCoveringOperationEnum> m_OperationType;
...
VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcPermeableCoveringProperties, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_OperationType, m_PanelPosition, m_FrameDepth, m_FrameThickness, m_ShapeAspectStyle);
