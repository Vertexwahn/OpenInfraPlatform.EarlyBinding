...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcStructuralCurveMember -----------------------
			// attributes:
			std::shared_ptr<IfcStructuralCurveMemberTypeEnum> m_PredefinedType;
			std::shared_ptr<IfcDirection> m_Axis;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcStructuralCurveMember, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_ObjectType, m_ObjectPlacement, m_Representation, m_PredefinedType, m_Axis);
