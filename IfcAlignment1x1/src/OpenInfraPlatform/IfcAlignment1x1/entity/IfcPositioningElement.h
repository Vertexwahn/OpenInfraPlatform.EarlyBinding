...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			virtual const char* classname() const { return "IfcPositioningElement"; }
...
VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcPositioningElement, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_ObjectType, m_ObjectPlacement, m_Representation);
