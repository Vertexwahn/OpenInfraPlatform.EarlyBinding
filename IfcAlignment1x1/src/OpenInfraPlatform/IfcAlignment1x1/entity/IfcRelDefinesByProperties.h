...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcRelDefinesByProperties -----------------------
			// attributes:
			std::vector<std::shared_ptr<IfcObjectDefinition>>  m_RelatedObjects;
			std::shared_ptr<IfcPropertySetDefinitionSelect> m_RelatingPropertyDefinition;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcRelDefinesByProperties, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_RelatedObjects, m_RelatingPropertyDefinition);
