...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcStructuralSurfaceMember -----------------------
			// attributes:
			std::shared_ptr<IfcStructuralSurfaceMemberTypeEnum> m_PredefinedType;
			std::shared_ptr<IfcPositiveLengthMeasure> m_Thickness;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcStructuralSurfaceMember, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_ObjectType, m_ObjectPlacement, m_Representation, m_PredefinedType, m_Thickness);
