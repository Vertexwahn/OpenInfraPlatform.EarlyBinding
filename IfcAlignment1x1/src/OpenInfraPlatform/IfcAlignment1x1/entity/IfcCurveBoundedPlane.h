...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcCurveBoundedPlane -----------------------
			// attributes:
			std::shared_ptr<IfcPlane> m_BasisSurface;
			std::shared_ptr<IfcCurve> m_OuterBoundary;
			std::vector<std::shared_ptr<IfcCurve>>  m_InnerBoundaries;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcCurveBoundedPlane, m_BasisSurface, m_OuterBoundary, m_InnerBoundaries);
