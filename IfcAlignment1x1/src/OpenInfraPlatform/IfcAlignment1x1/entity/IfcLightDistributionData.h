...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcLightDistributionData : public IfcAlignment1x1Entity
		{
		public:
			...
			// IfcLightDistributionData -----------------------
			// attributes:
			std::shared_ptr<IfcPlaneAngleMeasure> m_MainPlaneAngle;
			std::vector<std::shared_ptr<IfcPlaneAngleMeasure>>  m_SecondaryPlaneAngle;
			std::vector<std::shared_ptr<IfcLuminousIntensityDistributionMeasure>>  m_LuminousIntensity;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcLightDistributionData, m_MainPlaneAngle, m_SecondaryPlaneAngle, m_LuminousIntensity);
