...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcStructuralItem : public IfcProduct, public IfcStructuralActivityAssignmentSelect
...
VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcStructuralItem, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_ObjectType, m_ObjectPlacement, m_Representation);
