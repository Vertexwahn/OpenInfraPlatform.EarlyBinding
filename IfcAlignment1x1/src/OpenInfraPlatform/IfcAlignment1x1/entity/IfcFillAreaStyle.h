...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcFillAreaStyle : public IfcPresentationStyle, public IfcPresentationStyleSelect
		...
		public:
			...
			// IfcFillAreaStyle -----------------------
			// attributes:
			std::vector<std::shared_ptr<IfcFillStyleSelect>>  m_FillStyles;
			std::shared_ptr<IfcBoolean> m_ModelorDraughting;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcFillAreaStyle, m_Name, m_FillStyles, m_ModelorDraughting);
