...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcCompositeCurveSegment -----------------------
			// attributes:
			std::shared_ptr<IfcTransitionCode> m_Transition;
			std::shared_ptr<IfcBoolean> m_SameSense;
			std::shared_ptr<IfcCurve> m_ParentCurve;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcCompositeCurveSegment, m_Transition, m_SameSense, m_ParentCurve);
