...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcResourceLevelRelationship : public IfcAlignment1x1Entity
		{
		public:
...
VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcResourceLevelRelationship, m_Name, m_Description);
