...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcCartesianPointList3D -----------------------
			// attributes:
			std::vector<std::vector<std::shared_ptr<IfcLengthMeasure>>>  m_CoordList;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcCartesianPointList3D, m_CoordList);
