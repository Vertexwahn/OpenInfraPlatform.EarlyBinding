...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		// ENTITY IfcProduct
		class IfcProduct : public IfcObject, public IfcProductSelect
		...
		public:
			...
			// IfcProduct -----------------------
			// attributes:
			std::shared_ptr<IfcObjectPlacement> m_ObjectPlacement;
			std::shared_ptr<IfcProductRepresentation> m_Representation;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcProduct, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_ObjectType, m_ObjectPlacement, m_Representation);
