...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcRelAggregates -----------------------
			// attributes:
			std::shared_ptr<IfcObjectDefinition> m_RelatingObject;
			std::vector<std::shared_ptr<IfcObjectDefinition>>  m_RelatedObjects;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcRelAggregates, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_RelatingObject, m_RelatedObjects);
