...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcBoolean;
		// ENTITY IfcTableRow
		class IfcTableRow : public IfcAlignment1x1Entity
		{
		public:
			IfcTableRow();
			IfcTableRow( int id );
			...
			// IfcTableRow -----------------------
			// attributes:
			std::vector<std::shared_ptr<IfcValue>>  m_RowCells;
			std::shared_ptr<IfcBoolean> m_IsHeading;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcTableRow, m_RowCells, m_IsHeading);
