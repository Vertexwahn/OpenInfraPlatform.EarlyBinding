...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcLocalPlacement -----------------------
			// attributes:
			std::shared_ptr<IfcObjectPlacement> m_PlacementRelTo;
			std::shared_ptr<IfcAxis2Placement> m_RelativePlacement;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcLocalPlacement, m_PlacementRelTo, m_RelativePlacement);
