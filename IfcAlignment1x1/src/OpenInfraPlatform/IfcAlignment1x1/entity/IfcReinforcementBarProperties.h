...
VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcReinforcementBarProperties, m_TotalCrossSectionArea, m_SteelGrade, m_BarSurface, m_EffectiveDepth, m_NominalBarDiameter, m_BarCount);
