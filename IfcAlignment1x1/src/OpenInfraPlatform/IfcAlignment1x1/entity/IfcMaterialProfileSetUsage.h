...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcMaterialProfileSetUsage -----------------------
			// attributes:
			std::shared_ptr<IfcMaterialProfileSet> m_ForProfileSet;
			std::shared_ptr<IfcCardinalPointReference> m_CardinalPoint;
			std::shared_ptr<IfcPositiveLengthMeasure> m_ReferenceExtent;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcMaterialProfileSetUsage, m_ForProfileSet, m_CardinalPoint, m_ReferenceExtent);
