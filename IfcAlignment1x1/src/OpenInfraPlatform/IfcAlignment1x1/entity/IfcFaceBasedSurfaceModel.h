...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcFaceBasedSurfaceModel : public IfcGeometricRepresentationItem, public IfcSurfaceOrFaceSurface
		...
		public:
			...
			// IfcFaceBasedSurfaceModel -----------------------
			// attributes:
			std::vector<std::shared_ptr<IfcConnectedFaceSet>>  m_FbsmFaces;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcFaceBasedSurfaceModel, m_FbsmFaces);
