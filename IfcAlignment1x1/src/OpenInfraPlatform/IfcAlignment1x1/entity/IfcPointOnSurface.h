...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			std::shared_ptr<IfcParameterValue> m_PointParameterU;
			std::shared_ptr<IfcParameterValue> m_PointParameterV;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcPointOnSurface, m_BasisSurface, m_PointParameterU, m_PointParameterV);
