...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcRegularTimeSeries -----------------------
			// attributes:
			std::shared_ptr<IfcTimeMeasure> m_TimeStep;
			std::vector<std::shared_ptr<IfcTimeSeriesValue>>  m_Values;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcRegularTimeSeries, m_Name, m_Description, m_StartTime, m_EndTime, m_TimeSeriesDataType, m_DataOrigin, m_UserDefinedDataOrigin, m_Unit, m_TimeStep, m_Values);
