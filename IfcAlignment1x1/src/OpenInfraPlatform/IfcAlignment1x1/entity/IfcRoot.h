...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcText;
		// ENTITY IfcRoot
		class IfcRoot : public IfcAlignment1x1Entity
		{
		public:
			IfcRoot();
			IfcRoot( int id );
			...
			std::shared_ptr<IfcOwnerHistory> m_OwnerHistory;
...
VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcRoot, m_GlobalId, m_OwnerHistory, m_Name, m_Description);
