...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcAlignmentCurve : public IfcBoundedCurve
		{
		public:
			IfcAlignmentCurve();
			...
			// IfcAlignmentCurve -----------------------
			// attributes:
			std::shared_ptr<IfcAlignment2DHorizontal> m_Horizontal;
			std::shared_ptr<IfcAlignment2DVertical> m_Vertical;
			std::shared_ptr<IfcLabel> m_Tag;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcAlignmentCurve, m_Horizontal, m_Vertical, m_Tag);
