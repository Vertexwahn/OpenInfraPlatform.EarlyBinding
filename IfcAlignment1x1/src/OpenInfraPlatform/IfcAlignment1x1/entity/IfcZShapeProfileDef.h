...
VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcZShapeProfileDef, m_ProfileType, m_ProfileName, m_Position, m_Depth, m_FlangeWidth, m_WebThickness, m_FlangeThickness, m_FilletRadius, m_EdgeRadius);
