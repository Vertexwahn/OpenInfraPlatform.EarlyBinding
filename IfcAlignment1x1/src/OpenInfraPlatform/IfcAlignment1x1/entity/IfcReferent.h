...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcReferent -----------------------
			// attributes:
			std::shared_ptr<IfcReferentTypeEnum> m_PredefinedType;
			std::shared_ptr<IfcLengthMeasure> m_RestartDistance;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcReferent, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_ObjectType, m_ObjectPlacement, m_Representation, m_PredefinedType, m_RestartDistance);
