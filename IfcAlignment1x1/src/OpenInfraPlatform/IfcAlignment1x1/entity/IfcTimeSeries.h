...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcTimeSeries : public IfcAlignment1x1Entity, public IfcMetricValueSelect
...
, public IfcResourceObjectSelect
		...
		public:
			...
			std::shared_ptr<IfcDateTime> m_EndTime;
			std::shared_ptr<IfcTimeSeriesDataTypeEnum> m_TimeSeriesDataType;
			std::shared_ptr<IfcDataOriginEnum> m_DataOrigin;
			std::shared_ptr<IfcLabel> m_UserDefinedDataOrigin;
			std::shared_ptr<IfcUnit> m_Unit;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcTimeSeries, m_Name, m_Description, m_StartTime, m_EndTime, m_TimeSeriesDataType, m_DataOrigin, m_UserDefinedDataOrigin, m_Unit);
