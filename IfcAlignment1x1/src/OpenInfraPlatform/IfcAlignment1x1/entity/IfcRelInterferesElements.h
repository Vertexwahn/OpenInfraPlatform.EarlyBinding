...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcRelInterferesElements -----------------------
			// attributes:
			std::shared_ptr<IfcElement> m_RelatingElement;
			std::shared_ptr<IfcElement> m_RelatedElement;
			std::shared_ptr<IfcConnectionGeometry> m_InterferenceGeometry;
			std::shared_ptr<IfcIdentifier> m_InterferenceType;
			bool m_ImpliedOrder;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcRelInterferesElements, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_RelatingElement, m_RelatedElement, m_InterferenceGeometry, m_InterferenceType, m_ImpliedOrder);
