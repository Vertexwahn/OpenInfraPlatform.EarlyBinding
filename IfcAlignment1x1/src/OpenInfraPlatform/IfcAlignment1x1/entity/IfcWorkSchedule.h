...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcWorkSchedule -----------------------
			// attributes:
			std::shared_ptr<IfcWorkScheduleTypeEnum> m_PredefinedType;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcWorkSchedule, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_ObjectType, m_Identification, m_CreationDate, m_Creators, m_Purpose, m_Duration, m_TotalFloat, m_StartTime, m_FinishTime, m_PredefinedType);
