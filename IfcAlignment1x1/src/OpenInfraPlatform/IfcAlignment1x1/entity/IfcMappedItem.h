...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcMappedItem -----------------------
			// attributes:
			std::shared_ptr<IfcRepresentationMap> m_MappingSource;
			std::shared_ptr<IfcCartesianTransformationOperator> m_MappingTarget;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcMappedItem, m_MappingSource, m_MappingTarget);
