...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			std::shared_ptr<IfcFeatureElementAddition> m_RelatedFeatureElement;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcRelProjectsElement, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_RelatingElement, m_RelatedFeatureElement);
