...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcEventTime -----------------------
			// attributes:
			std::shared_ptr<IfcDateTime> m_ActualDate;
			std::shared_ptr<IfcDateTime> m_EarlyDate;
			std::shared_ptr<IfcDateTime> m_LateDate;
			std::shared_ptr<IfcDateTime> m_ScheduleDate;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcEventTime, m_Name, m_DataOrigin, m_UserDefinedDataOrigin, m_ActualDate, m_EarlyDate, m_LateDate, m_ScheduleDate);
