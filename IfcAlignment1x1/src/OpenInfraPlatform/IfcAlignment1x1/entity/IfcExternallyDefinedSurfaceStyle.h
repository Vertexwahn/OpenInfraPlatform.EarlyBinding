...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcExternallyDefinedSurfaceStyle : public IfcExternalReference, public IfcSurfaceStyleElementSelect
...
VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcExternallyDefinedSurfaceStyle, m_Location, m_Identification, m_Name);
