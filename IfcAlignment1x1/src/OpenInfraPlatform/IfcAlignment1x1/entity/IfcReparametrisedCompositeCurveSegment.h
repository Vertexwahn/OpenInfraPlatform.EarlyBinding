...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcReparametrisedCompositeCurveSegment -----------------------
			// attributes:
			std::shared_ptr<IfcParameterValue> m_ParamLength;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcReparametrisedCompositeCurveSegment, m_Transition, m_SameSense, m_ParentCurve, m_ParamLength);
