...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcLabel;
		// ENTITY IfcAddress
		class IfcAddress : public IfcAlignment1x1Entity, public IfcObjectReferenceSelect
		...
		public:
			...
			// IfcAddress -----------------------
			// attributes:
			std::shared_ptr<IfcAddressTypeEnum> m_Purpose;
			std::shared_ptr<IfcText> m_Description;
			std::shared_ptr<IfcLabel> m_UserDefinedPurpose;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcAddress, m_Purpose, m_Description, m_UserDefinedPurpose);
