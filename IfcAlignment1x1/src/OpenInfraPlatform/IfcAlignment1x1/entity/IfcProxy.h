...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcProxy -----------------------
			// attributes:
			std::shared_ptr<IfcObjectTypeEnum> m_ProxyType;
			std::shared_ptr<IfcLabel> m_Tag;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcProxy, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_ObjectType, m_ObjectPlacement, m_Representation, m_ProxyType, m_Tag);
