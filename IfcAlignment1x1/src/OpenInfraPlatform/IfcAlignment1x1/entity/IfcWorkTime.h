...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcWorkTime -----------------------
			// attributes:
			std::shared_ptr<IfcRecurrencePattern> m_RecurrencePattern;
			std::shared_ptr<IfcDate> m_Start;
			std::shared_ptr<IfcDate> m_Finish;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcWorkTime, m_Name, m_DataOrigin, m_UserDefinedDataOrigin, m_RecurrencePattern, m_Start, m_Finish);
