...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcCurveSegment2D -----------------------
			// attributes:
			std::shared_ptr<IfcCartesianPoint> m_StartPoint;
			std::shared_ptr<IfcPlaneAngleMeasure> m_StartDirection;
			std::shared_ptr<IfcPositiveLengthMeasure> m_SegmentLength;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcCurveSegment2D, m_StartPoint, m_StartDirection, m_SegmentLength);
