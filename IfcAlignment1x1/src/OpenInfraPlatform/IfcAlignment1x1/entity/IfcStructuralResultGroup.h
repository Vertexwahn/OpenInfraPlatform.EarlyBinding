...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcStructuralResultGroup -----------------------
			// attributes:
			std::shared_ptr<IfcAnalysisTheoryTypeEnum> m_TheoryType;
			std::shared_ptr<IfcStructuralLoadGroup> m_ResultForLoadGroup;
			std::shared_ptr<IfcBoolean> m_IsLinear;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcStructuralResultGroup, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_ObjectType, m_TheoryType, m_ResultForLoadGroup, m_IsLinear);
