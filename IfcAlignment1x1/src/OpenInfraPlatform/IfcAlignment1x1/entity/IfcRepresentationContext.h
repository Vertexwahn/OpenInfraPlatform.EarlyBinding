...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcRepresentationContext : public IfcAlignment1x1Entity
		{
		public:
			...
			// IfcRepresentationContext -----------------------
			// attributes:
			std::shared_ptr<IfcLabel> m_ContextIdentifier;
			std::shared_ptr<IfcLabel> m_ContextType;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcRepresentationContext, m_ContextIdentifier, m_ContextType);
