...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcTextureMap -----------------------
			// attributes:
			std::vector<std::shared_ptr<IfcTextureVertex>>  m_Vertices;
			std::shared_ptr<IfcFace> m_MappedTo;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcTextureMap, m_Maps, m_Vertices, m_MappedTo);
