...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcRelAssociatesLibrary -----------------------
			// attributes:
			std::shared_ptr<IfcLibrarySelect> m_RelatingLibrary;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcRelAssociatesLibrary, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_RelatedObjects, m_RelatingLibrary);
