...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcMaterialProfileSetUsageTapering -----------------------
			// attributes:
			std::shared_ptr<IfcMaterialProfileSet> m_ForProfileEndSet;
			std::shared_ptr<IfcCardinalPointReference> m_CardinalEndPoint;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcMaterialProfileSetUsageTapering, m_ForProfileSet, m_CardinalPoint, m_ReferenceExtent, m_ForProfileEndSet, m_CardinalEndPoint);
