...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcRelAssignsToGroup -----------------------
			// attributes:
			std::shared_ptr<IfcGroup> m_RelatingGroup;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcRelAssignsToGroup, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_RelatedObjects, m_RelatedObjectsType, m_RelatingGroup);
