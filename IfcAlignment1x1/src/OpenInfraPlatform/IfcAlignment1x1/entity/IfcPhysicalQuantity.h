...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcPhysicalQuantity : public IfcAlignment1x1Entity, public IfcResourceObjectSelect
...
VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcPhysicalQuantity, m_Name, m_Description);
