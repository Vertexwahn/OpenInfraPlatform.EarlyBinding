...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			std::vector<std::shared_ptr<IfcIndexedPolygonalFace>>  m_Faces;
			std::vector<std::shared_ptr<IfcPositiveInteger>>  m_PnIndex;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcPolygonalFaceSet, m_Coordinates, m_Closed, m_Faces, m_PnIndex);
