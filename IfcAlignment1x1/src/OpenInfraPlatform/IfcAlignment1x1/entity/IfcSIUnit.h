...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcSIUnit -----------------------
			// attributes:
			std::shared_ptr<IfcSIPrefix> m_Prefix;
			std::shared_ptr<IfcSIUnitName> m_Name;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcSIUnit, m_Dimensions, m_UnitType, m_Prefix, m_Name);
