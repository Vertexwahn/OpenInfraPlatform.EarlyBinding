...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcTrapeziumProfileDef -----------------------
			// attributes:
			std::shared_ptr<IfcPositiveLengthMeasure> m_BottomXDim;
			std::shared_ptr<IfcPositiveLengthMeasure> m_TopXDim;
			std::shared_ptr<IfcPositiveLengthMeasure> m_YDim;
			std::shared_ptr<IfcLengthMeasure> m_TopXOffset;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcTrapeziumProfileDef, m_ProfileType, m_ProfileName, m_Position, m_BottomXDim, m_TopXDim, m_YDim, m_TopXOffset);
