...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcQuantityTime -----------------------
			// attributes:
			std::shared_ptr<IfcTimeMeasure> m_TimeValue;
			std::shared_ptr<IfcLabel> m_Formula;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcQuantityTime, m_Name, m_Description, m_Unit, m_TimeValue, m_Formula);
