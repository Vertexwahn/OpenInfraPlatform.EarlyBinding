...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcDerivedUnit : public IfcAlignment1x1Entity, public IfcUnit
		...
		public:
			...
			// IfcDerivedUnit -----------------------
			// attributes:
			std::vector<std::shared_ptr<IfcDerivedUnitElement>>  m_Elements;
			std::shared_ptr<IfcDerivedUnitEnum> m_UnitType;
			std::shared_ptr<IfcLabel> m_UserDefinedType;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcDerivedUnit, m_Elements, m_UnitType, m_UserDefinedType);
