...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcPropertySingleValue -----------------------
			// attributes:
			std::shared_ptr<IfcValue> m_NominalValue;
			std::shared_ptr<IfcUnit> m_Unit;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcPropertySingleValue, m_Name, m_Description, m_NominalValue, m_Unit);
