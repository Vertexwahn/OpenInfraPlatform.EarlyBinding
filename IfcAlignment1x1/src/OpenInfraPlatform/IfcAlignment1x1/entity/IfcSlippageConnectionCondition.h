...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcSlippageConnectionCondition -----------------------
			// attributes:
			std::shared_ptr<IfcLengthMeasure> m_SlippageX;
			std::shared_ptr<IfcLengthMeasure> m_SlippageY;
			std::shared_ptr<IfcLengthMeasure> m_SlippageZ;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcSlippageConnectionCondition, m_Name, m_SlippageX, m_SlippageY, m_SlippageZ);
