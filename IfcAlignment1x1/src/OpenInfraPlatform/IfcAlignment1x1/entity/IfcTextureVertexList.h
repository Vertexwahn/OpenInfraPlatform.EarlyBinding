...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcTextureVertexList -----------------------
			// attributes:
			std::vector<std::vector<std::shared_ptr<IfcParameterValue>>>  m_TexCoordsList;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcTextureVertexList, m_TexCoordsList);
