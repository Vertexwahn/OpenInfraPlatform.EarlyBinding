...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcArbitraryProfileDefWithVoids -----------------------
			// attributes:
			std::vector<std::shared_ptr<IfcCurve>>  m_InnerCurves;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcArbitraryProfileDefWithVoids, m_ProfileType, m_ProfileName, m_OuterCurve, m_InnerCurves);
