...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcQuantityVolume -----------------------
			// attributes:
			std::shared_ptr<IfcVolumeMeasure> m_VolumeValue;
			std::shared_ptr<IfcLabel> m_Formula;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcQuantityVolume, m_Name, m_Description, m_Unit, m_VolumeValue, m_Formula);
