...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcLinearPlacement -----------------------
			// attributes:
			std::shared_ptr<IfcCurve> m_PlacementRelTo;
			std::shared_ptr<IfcDistanceExpression> m_Distance;
			std::shared_ptr<IfcOrientationExpression> m_Orientation;
			std::shared_ptr<IfcAxis2Placement3D> m_CartesianPosition;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcLinearPlacement, m_PlacementRelTo, m_Distance, m_Orientation, m_CartesianPosition);
