...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcPropertyReferenceValue -----------------------
			// attributes:
			std::shared_ptr<IfcText> m_UsageName;
			std::shared_ptr<IfcObjectReferenceSelect> m_PropertyReference;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcPropertyReferenceValue, m_Name, m_Description, m_UsageName, m_PropertyReference);
