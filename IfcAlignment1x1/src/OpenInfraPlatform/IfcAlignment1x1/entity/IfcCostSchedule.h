...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcCostSchedule -----------------------
			// attributes:
			std::shared_ptr<IfcCostScheduleTypeEnum> m_PredefinedType;
			std::shared_ptr<IfcLabel> m_Status;
			std::shared_ptr<IfcDateTime> m_SubmittedOn;
			std::shared_ptr<IfcDateTime> m_UpdateDate;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcCostSchedule, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_ObjectType, m_Identification, m_PredefinedType, m_Status, m_SubmittedOn, m_UpdateDate);
