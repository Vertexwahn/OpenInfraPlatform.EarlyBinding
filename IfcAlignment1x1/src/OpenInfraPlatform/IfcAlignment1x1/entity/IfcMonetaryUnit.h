...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcMonetaryUnit : public IfcAlignment1x1Entity, public IfcUnit
		...
		public:
			...
			// IfcMonetaryUnit -----------------------
			// attributes:
			std::shared_ptr<IfcLabel> m_Currency;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcMonetaryUnit, m_Currency);
