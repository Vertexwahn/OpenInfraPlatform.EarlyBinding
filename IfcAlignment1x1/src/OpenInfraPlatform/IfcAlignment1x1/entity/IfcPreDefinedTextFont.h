...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcPreDefinedTextFont : public IfcPreDefinedItem, public IfcTextFontSelect
...
VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcPreDefinedTextFont, m_Name);
