...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcStructuralLoadSingleForceWarping -----------------------
			// attributes:
			std::shared_ptr<IfcWarpingMomentMeasure> m_WarpingMoment;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcStructuralLoadSingleForceWarping, m_Name, m_ForceX, m_ForceY, m_ForceZ, m_MomentX, m_MomentY, m_MomentZ, m_WarpingMoment);
