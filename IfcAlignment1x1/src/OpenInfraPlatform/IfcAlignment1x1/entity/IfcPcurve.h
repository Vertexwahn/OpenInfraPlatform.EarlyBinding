...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcCurve;
		// ENTITY IfcPcurve
		class IfcPcurve : public IfcCurve, public IfcCurveOnSurface
		...
		public:
			...
			std::shared_ptr<IfcCurve> m_ReferenceCurve;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcPcurve, m_BasisSurface, m_ReferenceCurve);
