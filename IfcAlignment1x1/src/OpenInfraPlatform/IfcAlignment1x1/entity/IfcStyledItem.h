...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcStyledItem -----------------------
			// attributes:
			std::shared_ptr<IfcRepresentationItem> m_Item;
			std::vector<std::shared_ptr<IfcStyleAssignmentSelect>>  m_Styles;
			std::shared_ptr<IfcLabel> m_Name;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcStyledItem, m_Item, m_Styles, m_Name);
