...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcReinforcementDefinitionProperties -----------------------
			// attributes:
			std::shared_ptr<IfcLabel> m_DefinitionType;
			std::vector<std::shared_ptr<IfcSectionReinforcementProperties>>  m_ReinforcementSectionDefinitions;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcReinforcementDefinitionProperties, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_DefinitionType, m_ReinforcementSectionDefinitions);
