...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcRelAssociatesConstraint -----------------------
			// attributes:
			std::shared_ptr<IfcLabel> m_Intent;
			std::shared_ptr<IfcConstraint> m_RelatingConstraint;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcRelAssociatesConstraint, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_RelatedObjects, m_Intent, m_RelatingConstraint);
