...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcAlignment2DVerSegParabolicArc -----------------------
			// attributes:
			std::shared_ptr<IfcPositiveLengthMeasure> m_ParabolaConstant;
			std::shared_ptr<IfcBoolean> m_IsConvex;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcAlignment2DVerSegParabolicArc, m_TangentialContinuity, m_StartTag, m_EndTag, m_StartDistAlong, m_HorizontalLength, m_StartHeight, m_StartGradient, m_ParabolaConstant, m_IsConvex);
