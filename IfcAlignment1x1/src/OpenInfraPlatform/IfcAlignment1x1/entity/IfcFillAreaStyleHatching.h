...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcFillAreaStyleHatching : public IfcGeometricRepresentationItem, public IfcFillStyleSelect
		...
		public:
			...
			// IfcFillAreaStyleHatching -----------------------
			// attributes:
			std::shared_ptr<IfcCurveStyle> m_HatchLineAppearance;
			std::shared_ptr<IfcHatchLineDistanceSelect> m_StartOfNextHatchLine;
			std::shared_ptr<IfcCartesianPoint> m_PointOfReferenceHatchLine;
			std::shared_ptr<IfcCartesianPoint> m_PatternStart;
			std::shared_ptr<IfcPlaneAngleMeasure> m_HatchLineAngle;
		};
	}
}
