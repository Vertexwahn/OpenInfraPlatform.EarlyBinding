...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcRelVoidsElement -----------------------
			// attributes:
			std::shared_ptr<IfcElement> m_RelatingBuildingElement;
			std::shared_ptr<IfcFeatureElementSubtraction> m_RelatedOpeningElement;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcRelVoidsElement, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_RelatingBuildingElement, m_RelatedOpeningElement);
