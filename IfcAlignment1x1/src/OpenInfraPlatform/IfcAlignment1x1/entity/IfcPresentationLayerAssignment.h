...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcPresentationLayerAssignment : public IfcAlignment1x1Entity
		{
		public:
			...
			std::vector<std::shared_ptr<IfcLayeredItem>>  m_AssignedItems;
			std::shared_ptr<IfcIdentifier> m_Identifier;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcPresentationLayerAssignment, m_Name, m_Description, m_AssignedItems, m_Identifier);
