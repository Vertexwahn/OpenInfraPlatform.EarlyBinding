...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcShapeAspect : public IfcAlignment1x1Entity, public IfcResourceObjectSelect
		...
		public:
			...
			// IfcShapeAspect -----------------------
			// attributes:
			std::vector<std::shared_ptr<IfcShapeModel>>  m_ShapeRepresentations;
			std::shared_ptr<IfcLabel> m_Name;
			std::shared_ptr<IfcText> m_Description;
			std::shared_ptr<IfcLogical> m_ProductDefinitional;
			std::shared_ptr<IfcProductRepresentationSelect> m_PartOfProductDefinitionShape;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcShapeAspect, m_ShapeRepresentations, m_Name, m_Description, m_ProductDefinitional, m_PartOfProductDefinitionShape);
