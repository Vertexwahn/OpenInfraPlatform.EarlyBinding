...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcStructuralConnectionCondition : public IfcAlignment1x1Entity
		{
		public:
...
VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcStructuralConnectionCondition, m_Name);
