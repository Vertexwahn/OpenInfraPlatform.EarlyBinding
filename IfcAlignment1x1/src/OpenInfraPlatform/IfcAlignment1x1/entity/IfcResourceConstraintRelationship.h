...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcResourceConstraintRelationship -----------------------
			// attributes:
			std::shared_ptr<IfcConstraint> m_RelatingConstraint;
			std::vector<std::shared_ptr<IfcResourceObjectSelect>>  m_RelatedResourceObjects;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcResourceConstraintRelationship, m_Name, m_Description, m_RelatingConstraint, m_RelatedResourceObjects);
