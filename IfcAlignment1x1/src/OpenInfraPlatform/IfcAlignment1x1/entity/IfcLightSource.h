...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			std::shared_ptr<IfcColourRgb> m_LightColour;
			std::shared_ptr<IfcNormalisedRatioMeasure> m_AmbientIntensity;
			std::shared_ptr<IfcNormalisedRatioMeasure> m_Intensity;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcLightSource, m_Name, m_LightColour, m_AmbientIntensity, m_Intensity);
