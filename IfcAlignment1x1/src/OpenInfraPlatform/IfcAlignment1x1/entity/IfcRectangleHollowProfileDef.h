...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcRectangleHollowProfileDef -----------------------
			// attributes:
			std::shared_ptr<IfcPositiveLengthMeasure> m_WallThickness;
			std::shared_ptr<IfcNonNegativeLengthMeasure> m_InnerFilletRadius;
			std::shared_ptr<IfcNonNegativeLengthMeasure> m_OuterFilletRadius;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcRectangleHollowProfileDef, m_ProfileType, m_ProfileName, m_Position, m_XDim, m_YDim, m_WallThickness, m_InnerFilletRadius, m_OuterFilletRadius);
