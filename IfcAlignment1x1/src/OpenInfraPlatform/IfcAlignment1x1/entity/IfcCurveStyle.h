...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcCurveStyle : public IfcPresentationStyle, public IfcPresentationStyleSelect
		...
		public:
			...
			// IfcCurveStyle -----------------------
			// attributes:
			std::shared_ptr<IfcCurveFontOrScaledCurveFontSelect> m_CurveFont;
			std::shared_ptr<IfcSizeSelect> m_CurveWidth;
			std::shared_ptr<IfcColour> m_CurveColour;
			std::shared_ptr<IfcBoolean> m_ModelOrDraughting;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcCurveStyle, m_Name, m_CurveFont, m_CurveWidth, m_CurveColour, m_ModelOrDraughting);
