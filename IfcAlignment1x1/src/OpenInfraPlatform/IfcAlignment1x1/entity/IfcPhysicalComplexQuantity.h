...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcPhysicalComplexQuantity -----------------------
			// attributes:
			std::vector<std::shared_ptr<IfcPhysicalQuantity>>  m_HasQuantities;
			std::shared_ptr<IfcLabel> m_Discrimination;
			std::shared_ptr<IfcLabel> m_Quality;
			std::shared_ptr<IfcLabel> m_Usage;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcPhysicalComplexQuantity, m_Name, m_Description, m_HasQuantities, m_Discrimination, m_Quality, m_Usage);
