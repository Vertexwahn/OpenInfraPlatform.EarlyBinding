...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcProjectedCRS -----------------------
			// attributes:
			std::shared_ptr<IfcIdentifier> m_MapProjection;
			std::shared_ptr<IfcIdentifier> m_MapZone;
			std::shared_ptr<IfcNamedUnit> m_MapUnit;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcProjectedCRS, m_Name, m_Description, m_GeodeticDatum, m_VerticalDatum, m_MapProjection, m_MapZone, m_MapUnit);
