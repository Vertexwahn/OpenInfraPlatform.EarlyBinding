...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcProductRepresentation : public IfcAlignment1x1Entity
		{
		public:
			...
			std::vector<std::shared_ptr<IfcRepresentation>>  m_Representations;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcProductRepresentation, m_Name, m_Description, m_Representations);
