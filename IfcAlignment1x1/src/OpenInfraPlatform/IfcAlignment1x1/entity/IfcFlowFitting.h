...
VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcFlowFitting, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_ObjectType, m_ObjectPlacement, m_Representation, m_Tag);
