...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcBuildingSystem -----------------------
			// attributes:
			std::shared_ptr<IfcBuildingSystemTypeEnum> m_PredefinedType;
			std::shared_ptr<IfcLabel> m_LongName;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcBuildingSystem, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_ObjectType, m_PredefinedType, m_LongName);
