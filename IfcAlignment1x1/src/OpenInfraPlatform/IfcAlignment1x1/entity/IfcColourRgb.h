...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcNormalisedRatioMeasure;
		// ENTITY IfcColourRgb
		class IfcColourRgb : public IfcColourSpecification, public IfcColourOrFactor
		...
		public:
			...
			// IfcColourRgb -----------------------
			// attributes:
			std::shared_ptr<IfcNormalisedRatioMeasure> m_Red;
			std::shared_ptr<IfcNormalisedRatioMeasure> m_Green;
			std::shared_ptr<IfcNormalisedRatioMeasure> m_Blue;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcColourRgb, m_Name, m_Red, m_Green, m_Blue);
