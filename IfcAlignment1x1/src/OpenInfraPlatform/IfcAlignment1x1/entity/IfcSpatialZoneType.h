...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcSpatialZoneType -----------------------
			// attributes:
			std::shared_ptr<IfcSpatialZoneTypeEnum> m_PredefinedType;
			std::shared_ptr<IfcLabel> m_LongName;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcSpatialZoneType, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_ApplicableOccurrence, m_HasPropertySets, m_RepresentationMaps, m_Tag, m_ElementType, m_PredefinedType, m_LongName);
