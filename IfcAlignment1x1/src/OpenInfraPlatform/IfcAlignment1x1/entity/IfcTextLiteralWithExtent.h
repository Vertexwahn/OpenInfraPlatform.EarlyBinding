...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcTextLiteralWithExtent -----------------------
			// attributes:
			std::shared_ptr<IfcPlanarExtent> m_Extent;
			std::shared_ptr<IfcBoxAlignment> m_BoxAlignment;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcTextLiteralWithExtent, m_Literal, m_Placement, m_Path, m_Extent, m_BoxAlignment);
