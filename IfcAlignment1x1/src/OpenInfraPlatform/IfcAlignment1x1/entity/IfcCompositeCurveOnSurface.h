...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcCompositeCurveOnSurface : public IfcCompositeCurve, public IfcCurveOnSurface
...
VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcCompositeCurveOnSurface, m_Segments, m_SelfIntersect);
