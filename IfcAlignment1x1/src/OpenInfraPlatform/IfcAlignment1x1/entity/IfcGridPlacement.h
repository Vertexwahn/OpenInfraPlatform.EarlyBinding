...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcGridPlacement -----------------------
			// attributes:
			std::shared_ptr<IfcVirtualGridIntersection> m_PlacementLocation;
			std::shared_ptr<IfcGridPlacementDirectionSelect> m_PlacementRefDirection;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcGridPlacement, m_PlacementLocation, m_PlacementRefDirection);
