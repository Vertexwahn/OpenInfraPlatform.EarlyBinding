...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			std::shared_ptr<IfcNormalisedRatioMeasure> m_Fraction;
			std::shared_ptr<IfcLabel> m_Category;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcMaterialConstituent, m_Name, m_Description, m_Material, m_Fraction, m_Category);
