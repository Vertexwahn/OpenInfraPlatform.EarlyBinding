...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcRelConnectsWithRealizingElements -----------------------
			// attributes:
			std::vector<std::shared_ptr<IfcElement>>  m_RealizingElements;
			std::shared_ptr<IfcLabel> m_ConnectionType;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcRelConnectsWithRealizingElements, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_ConnectionGeometry, m_RelatingElement, m_RelatedElement, m_RealizingElements, m_ConnectionType);
