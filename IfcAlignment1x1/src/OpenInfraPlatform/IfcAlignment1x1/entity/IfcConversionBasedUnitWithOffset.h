...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcConversionBasedUnitWithOffset -----------------------
			// attributes:
			std::shared_ptr<IfcReal> m_ConversionOffset;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcConversionBasedUnitWithOffset, m_Dimensions, m_UnitType, m_Name, m_ConversionFactor, m_ConversionOffset);
