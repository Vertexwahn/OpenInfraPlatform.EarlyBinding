...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcColourRgbList -----------------------
			// attributes:
			std::vector<std::vector<std::shared_ptr<IfcNormalisedRatioMeasure>>>  m_ColourList;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcColourRgbList, m_ColourList);
