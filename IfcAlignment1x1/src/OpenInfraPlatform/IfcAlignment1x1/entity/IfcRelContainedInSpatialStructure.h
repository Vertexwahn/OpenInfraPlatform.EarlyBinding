...
VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcRelContainedInSpatialStructure, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_RelatedElements, m_RelatingStructure);
