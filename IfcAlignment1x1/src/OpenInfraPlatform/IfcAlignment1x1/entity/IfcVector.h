...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		// ENTITY IfcVector
		class IfcVector : public IfcGeometricRepresentationItem, public IfcHatchLineDistanceSelect
, public IfcVectorOrDirection
		...
		public:
			...
			std::shared_ptr<IfcLengthMeasure> m_Magnitude;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcVector, m_Orientation, m_Magnitude);
