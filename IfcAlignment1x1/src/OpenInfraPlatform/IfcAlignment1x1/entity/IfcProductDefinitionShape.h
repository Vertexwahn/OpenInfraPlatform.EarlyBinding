...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcProductDefinitionShape : public IfcProductRepresentation, public IfcProductRepresentationSelect
...
VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcProductDefinitionShape, m_Name, m_Description, m_Representations);
