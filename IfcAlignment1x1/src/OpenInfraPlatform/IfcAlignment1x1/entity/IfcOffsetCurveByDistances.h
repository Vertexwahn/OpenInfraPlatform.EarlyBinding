...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcOffsetCurveByDistances -----------------------
			// attributes:
			std::vector<std::shared_ptr<IfcDistanceExpression>>  m_OffsetValues;
			std::shared_ptr<IfcLabel> m_Tag;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcOffsetCurveByDistances, m_BasisCurve, m_OffsetValues, m_Tag);
