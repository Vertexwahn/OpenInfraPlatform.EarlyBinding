...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcRelFlowControlElements -----------------------
			// attributes:
			std::vector<std::shared_ptr<IfcDistributionControlElement>>  m_RelatedControlElements;
			std::shared_ptr<IfcDistributionFlowElement> m_RelatingFlowElement;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcRelFlowControlElements, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_RelatedControlElements, m_RelatingFlowElement);
