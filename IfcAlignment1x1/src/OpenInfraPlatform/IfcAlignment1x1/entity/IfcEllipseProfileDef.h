...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcEllipseProfileDef -----------------------
			// attributes:
			std::shared_ptr<IfcPositiveLengthMeasure> m_SemiAxis1;
			std::shared_ptr<IfcPositiveLengthMeasure> m_SemiAxis2;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcEllipseProfileDef, m_ProfileType, m_ProfileName, m_Position, m_SemiAxis1, m_SemiAxis2);
