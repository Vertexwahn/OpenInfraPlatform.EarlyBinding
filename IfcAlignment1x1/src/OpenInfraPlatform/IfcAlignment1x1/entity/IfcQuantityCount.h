...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcQuantityCount -----------------------
			// attributes:
			std::shared_ptr<IfcCountMeasure> m_CountValue;
			std::shared_ptr<IfcLabel> m_Formula;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcQuantityCount, m_Name, m_Description, m_Unit, m_CountValue, m_Formula);
