...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcRepresentationMap : public IfcAlignment1x1Entity, public IfcProductRepresentationSelect
		...
		public:
			...
			// IfcRepresentationMap -----------------------
			// attributes:
			std::shared_ptr<IfcAxis2Placement> m_MappingOrigin;
			std::shared_ptr<IfcRepresentation> m_MappedRepresentation;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcRepresentationMap, m_MappingOrigin, m_MappedRepresentation);
