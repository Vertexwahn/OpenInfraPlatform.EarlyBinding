...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcRelAssociates -----------------------
			// attributes:
			std::vector<std::shared_ptr<IfcDefinitionSelect>>  m_RelatedObjects;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcRelAssociates, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_RelatedObjects);
