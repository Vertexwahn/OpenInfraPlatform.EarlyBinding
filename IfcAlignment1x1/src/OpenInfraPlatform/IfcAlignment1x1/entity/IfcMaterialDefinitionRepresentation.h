...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcMaterialDefinitionRepresentation -----------------------
			// attributes:
			std::shared_ptr<IfcMaterial> m_RepresentedMaterial;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcMaterialDefinitionRepresentation, m_Name, m_Description, m_Representations, m_RepresentedMaterial);
