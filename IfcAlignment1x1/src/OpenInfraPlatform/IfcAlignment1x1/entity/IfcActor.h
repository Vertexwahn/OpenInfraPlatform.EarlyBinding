...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcActor -----------------------
			// attributes:
			std::shared_ptr<IfcActorSelect> m_TheActor;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcActor, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_ObjectType, m_TheActor);
