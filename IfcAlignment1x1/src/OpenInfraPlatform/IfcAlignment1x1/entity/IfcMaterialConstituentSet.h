...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			std::vector<std::shared_ptr<IfcMaterialConstituent>>  m_MaterialConstituents;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcMaterialConstituentSet, m_Name, m_Description, m_MaterialConstituents);
