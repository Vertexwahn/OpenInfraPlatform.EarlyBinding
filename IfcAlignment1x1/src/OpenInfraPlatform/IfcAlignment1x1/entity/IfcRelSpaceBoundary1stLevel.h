...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcRelSpaceBoundary1stLevel -----------------------
			// attributes:
			std::shared_ptr<IfcRelSpaceBoundary1stLevel> m_ParentBoundary;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcRelSpaceBoundary1stLevel, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_RelatingSpace, m_RelatedBuildingElement, m_ConnectionGeometry, m_PhysicalOrVirtualBoundary, m_InternalOrExternalBoundary, m_ParentBoundary);
