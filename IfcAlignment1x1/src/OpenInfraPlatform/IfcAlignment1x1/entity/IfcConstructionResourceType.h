...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcConstructionResourceType -----------------------
			// attributes:
			std::vector<std::shared_ptr<IfcAppliedValue>>  m_BaseCosts;
			std::shared_ptr<IfcPhysicalQuantity> m_BaseQuantity;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcConstructionResourceType, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_ApplicableOccurrence, m_HasPropertySets, m_Identification, m_LongDescription, m_ResourceType, m_BaseCosts, m_BaseQuantity);
