...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcRelDeclares -----------------------
			// attributes:
			std::shared_ptr<IfcContext> m_RelatingContext;
			std::vector<std::shared_ptr<IfcDefinitionSelect>>  m_RelatedDefinitions;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcRelDeclares, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_RelatingContext, m_RelatedDefinitions);
