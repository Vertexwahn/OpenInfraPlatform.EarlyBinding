...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcRelSpaceBoundary2ndLevel -----------------------
			// attributes:
			std::shared_ptr<IfcRelSpaceBoundary2ndLevel> m_CorrespondingBoundary;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcRelSpaceBoundary2ndLevel, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_RelatingSpace, m_RelatedBuildingElement, m_ConnectionGeometry, m_PhysicalOrVirtualBoundary, m_InternalOrExternalBoundary, m_ParentBoundary, m_CorrespondingBoundary);
