...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcStructuralLoadSingleForce -----------------------
			// attributes:
			std::shared_ptr<IfcForceMeasure> m_ForceX;
			std::shared_ptr<IfcForceMeasure> m_ForceY;
			std::shared_ptr<IfcForceMeasure> m_ForceZ;
			std::shared_ptr<IfcTorqueMeasure> m_MomentX;
			std::shared_ptr<IfcTorqueMeasure> m_MomentY;
			std::shared_ptr<IfcTorqueMeasure> m_MomentZ;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcStructuralLoadSingleForce, m_Name, m_ForceX, m_ForceY, m_ForceZ, m_MomentX, m_MomentY, m_MomentZ);
