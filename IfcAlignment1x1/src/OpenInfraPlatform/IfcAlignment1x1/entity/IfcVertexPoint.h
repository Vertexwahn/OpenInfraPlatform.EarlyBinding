...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcVertexPoint : public IfcVertex, public IfcPointOrVertexPoint
		...
		public:
			...
			// IfcVertexPoint -----------------------
			// attributes:
			std::shared_ptr<IfcPoint> m_VertexGeometry;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcVertexPoint, m_VertexGeometry);
