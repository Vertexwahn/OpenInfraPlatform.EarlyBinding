...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcColourSpecification : public IfcPresentationItem, public IfcColour
...
VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcColourSpecification, m_Name);
