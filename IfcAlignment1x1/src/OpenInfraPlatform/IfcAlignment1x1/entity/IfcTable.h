...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		// ENTITY IfcTable
		class IfcTable : public IfcAlignment1x1Entity, public IfcMetricValueSelect
, public IfcObjectReferenceSelect
		...
		public:
			...
			std::vector<std::shared_ptr<IfcTableRow>>  m_Rows;
			std::vector<std::shared_ptr<IfcTableColumn>>  m_Columns;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcTable, m_Name, m_Rows, m_Columns);
