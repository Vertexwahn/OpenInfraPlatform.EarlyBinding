...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcRoundedRectangleProfileDef -----------------------
			// attributes:
			std::shared_ptr<IfcPositiveLengthMeasure> m_RoundingRadius;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcRoundedRectangleProfileDef, m_ProfileType, m_ProfileName, m_Position, m_XDim, m_YDim, m_RoundingRadius);
