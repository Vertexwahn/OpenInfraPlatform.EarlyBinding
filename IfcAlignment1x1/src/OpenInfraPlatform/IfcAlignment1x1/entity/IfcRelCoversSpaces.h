...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcRelCoversSpaces -----------------------
			// attributes:
			std::shared_ptr<IfcSpace> m_RelatingSpace;
			std::vector<std::shared_ptr<IfcCovering>>  m_RelatedCoverings;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcRelCoversSpaces, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_RelatingSpace, m_RelatedCoverings);
