...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcTextStyleForDefinedFont -----------------------
			// attributes:
			std::shared_ptr<IfcColour> m_Colour;
			std::shared_ptr<IfcColour> m_BackgroundColour;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcTextStyleForDefinedFont, m_Colour, m_BackgroundColour);
