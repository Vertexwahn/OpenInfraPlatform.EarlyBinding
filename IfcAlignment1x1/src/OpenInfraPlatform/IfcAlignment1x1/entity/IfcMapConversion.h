...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcMapConversion -----------------------
			// attributes:
			std::shared_ptr<IfcLengthMeasure> m_Eastings;
			std::shared_ptr<IfcLengthMeasure> m_Northings;
			std::shared_ptr<IfcLengthMeasure> m_OrthogonalHeight;
			std::shared_ptr<IfcReal> m_XAxisAbscissa;
			std::shared_ptr<IfcReal> m_XAxisOrdinate;
			std::shared_ptr<IfcReal> m_Scale;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcMapConversion, m_SourceCRS, m_TargetCRS, m_Eastings, m_Northings, m_OrthogonalHeight, m_XAxisAbscissa, m_XAxisOrdinate, m_Scale);
