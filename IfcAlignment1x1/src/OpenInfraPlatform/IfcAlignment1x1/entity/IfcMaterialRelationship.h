...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcMaterialRelationship -----------------------
			// attributes:
			std::shared_ptr<IfcMaterial> m_RelatingMaterial;
			std::vector<std::shared_ptr<IfcMaterial>>  m_RelatedMaterials;
			std::shared_ptr<IfcLabel> m_Expression;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcMaterialRelationship, m_Name, m_Description, m_RelatingMaterial, m_RelatedMaterials, m_Expression);
