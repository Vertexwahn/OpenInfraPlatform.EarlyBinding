...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcLibraryInformation : public IfcExternalInformation, public IfcLibrarySelect
		...
		public:
			...
			std::shared_ptr<IfcActorSelect> m_Publisher;
			std::shared_ptr<IfcDateTime> m_VersionDate;
...
VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcLibraryInformation, m_Name, m_Version, m_Publisher, m_VersionDate, m_Location, m_Description);
