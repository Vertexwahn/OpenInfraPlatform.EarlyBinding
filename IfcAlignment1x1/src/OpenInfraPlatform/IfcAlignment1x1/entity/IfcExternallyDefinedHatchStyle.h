...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcExternallyDefinedHatchStyle : public IfcExternalReference, public IfcFillStyleSelect
...
VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcExternallyDefinedHatchStyle, m_Location, m_Identification, m_Name);
