...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcRelConnectsStructuralActivity -----------------------
			// attributes:
			std::shared_ptr<IfcStructuralActivityAssignmentSelect> m_RelatingElement;
			std::shared_ptr<IfcStructuralActivity> m_RelatedStructuralActivity;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcRelConnectsStructuralActivity, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_RelatingElement, m_RelatedStructuralActivity);
