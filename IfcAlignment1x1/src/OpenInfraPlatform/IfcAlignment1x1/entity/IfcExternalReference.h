...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcExternalReference : public IfcAlignment1x1Entity, public IfcLightDistributionDataSourceSelect
...
VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcExternalReference, m_Location, m_Identification, m_Name);
