...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcExternalReferenceRelationship -----------------------
			// attributes:
			std::shared_ptr<IfcExternalReference> m_RelatingReference;
			std::vector<std::shared_ptr<IfcResourceObjectSelect>>  m_RelatedResourceObjects;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcExternalReferenceRelationship, m_Name, m_Description, m_RelatingReference, m_RelatedResourceObjects);
