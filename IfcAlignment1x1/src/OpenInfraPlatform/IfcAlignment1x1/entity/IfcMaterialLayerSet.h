...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcMaterialLayerSet -----------------------
			// attributes:
			std::vector<std::shared_ptr<IfcMaterialLayer>>  m_MaterialLayers;
			std::shared_ptr<IfcLabel> m_LayerSetName;
			std::shared_ptr<IfcText> m_Description;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcMaterialLayerSet, m_MaterialLayers, m_LayerSetName, m_Description);
