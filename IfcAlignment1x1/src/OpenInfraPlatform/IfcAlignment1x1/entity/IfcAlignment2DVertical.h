...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcAlignment2DVertical : public IfcAlignment1x1Entity
		{
		public:
			...
			// IfcAlignment2DVertical -----------------------
			// attributes:
			std::vector<std::shared_ptr<IfcAlignment2DVerticalSegment>>  m_Segments;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcAlignment2DVertical, m_Segments);
