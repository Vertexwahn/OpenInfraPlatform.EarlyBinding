...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcLagTime -----------------------
			// attributes:
			std::shared_ptr<IfcTimeOrRatioSelect> m_LagValue;
			std::shared_ptr<IfcTaskDurationEnum> m_DurationType;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcLagTime, m_Name, m_DataOrigin, m_UserDefinedDataOrigin, m_LagValue, m_DurationType);
