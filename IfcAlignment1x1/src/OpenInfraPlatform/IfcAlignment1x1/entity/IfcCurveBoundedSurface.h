...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			std::vector<std::shared_ptr<IfcBoundaryCurve>>  m_Boundaries;
			std::shared_ptr<IfcBoolean> m_ImplicitOuter;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcCurveBoundedSurface, m_BasisSurface, m_Boundaries, m_ImplicitOuter);
