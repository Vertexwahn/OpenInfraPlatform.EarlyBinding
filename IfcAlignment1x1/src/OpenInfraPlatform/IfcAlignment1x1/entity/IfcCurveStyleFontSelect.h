...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			static std::shared_ptr<IfcCurveStyleFontSelect> readStepData(const std::string& arg, const std::map<int,shared_ptr<IfcAlignment1x1Entity> >& map);
		}; // end class IfcCurveStyleFontSelect
