...
VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcTaskType, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_ApplicableOccurrence, m_HasPropertySets, m_Identification, m_LongDescription, m_ProcessType, m_PredefinedType, m_WorkMethod);
