...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcExtrudedAreaSolidTapered -----------------------
			// attributes:
			std::shared_ptr<IfcProfileDef> m_EndSweptArea;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcExtrudedAreaSolidTapered, m_SweptArea, m_Position, m_ExtrudedDirection, m_Depth, m_EndSweptArea);
