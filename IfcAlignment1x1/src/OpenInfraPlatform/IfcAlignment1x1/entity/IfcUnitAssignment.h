...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcUnitAssignment : public IfcAlignment1x1Entity
		{
		public:
			IfcUnitAssignment();
			...
			// IfcUnitAssignment -----------------------
			// attributes:
			std::vector<std::shared_ptr<IfcUnit>>  m_Units;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcUnitAssignment, m_Units);
