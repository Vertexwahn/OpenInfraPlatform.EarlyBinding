...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcDistributionPort -----------------------
			// attributes:
			std::shared_ptr<IfcFlowDirectionEnum> m_FlowDirection;
			std::shared_ptr<IfcDistributionPortTypeEnum> m_PredefinedType;
			std::shared_ptr<IfcDistributionSystemEnum> m_SystemType;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcDistributionPort, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_ObjectType, m_ObjectPlacement, m_Representation, m_FlowDirection, m_PredefinedType, m_SystemType);
