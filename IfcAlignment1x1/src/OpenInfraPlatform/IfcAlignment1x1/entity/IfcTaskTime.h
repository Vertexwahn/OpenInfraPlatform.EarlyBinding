...
VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcTaskTime, m_Name, m_DataOrigin, m_UserDefinedDataOrigin, m_DurationType, m_ScheduleDuration, m_ScheduleStart, m_ScheduleFinish, m_EarlyStart, m_EarlyFinish, m_LateStart, m_LateFinish, m_FreeFloat, m_TotalFloat, m_IsCritical, m_StatusTime, m_ActualDuration, m_ActualStart, m_ActualFinish, m_RemainingTime, m_Completion);
