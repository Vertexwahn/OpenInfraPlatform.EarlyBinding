...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcCurveStyleFontPattern -----------------------
			// attributes:
			std::shared_ptr<IfcLengthMeasure> m_VisibleSegmentLength;
			std::shared_ptr<IfcPositiveLengthMeasure> m_InvisibleSegmentLength;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcCurveStyleFontPattern, m_VisibleSegmentLength, m_InvisibleSegmentLength);
