...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcSurfaceOfRevolution -----------------------
			// attributes:
			std::shared_ptr<IfcAxis1Placement> m_AxisPosition;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcSurfaceOfRevolution, m_SweptCurve, m_Position, m_AxisPosition);
