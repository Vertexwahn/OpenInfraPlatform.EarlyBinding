...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		class IfcReal;
		// ENTITY IfcDirection
		class IfcDirection : public IfcGeometricRepresentationItem, public IfcGridPlacementDirectionSelect
, public IfcVectorOrDirection
		...
		public:
			...
			// IfcDirection -----------------------
			// attributes:
			std::vector<std::shared_ptr<IfcReal>>  m_DirectionRatios;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcDirection, m_DirectionRatios);
