...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcMaterialProperties -----------------------
			// attributes:
			std::shared_ptr<IfcMaterialDefinition> m_Material;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcMaterialProperties, m_Name, m_Description, m_Properties, m_Material);
