...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcRelAssociatesMaterial -----------------------
			// attributes:
			std::shared_ptr<IfcMaterialSelect> m_RelatingMaterial;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcRelAssociatesMaterial, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_RelatedObjects, m_RelatingMaterial);
