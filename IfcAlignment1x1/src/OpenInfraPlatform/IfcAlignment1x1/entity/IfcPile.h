...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcPile -----------------------
			// attributes:
			std::shared_ptr<IfcPileTypeEnum> m_PredefinedType;
			std::shared_ptr<IfcPileConstructionEnum> m_ConstructionType;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcPile, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_ObjectType, m_ObjectPlacement, m_Representation, m_Tag, m_PredefinedType, m_ConstructionType);
