...
VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcRelConnectsElements, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_ConnectionGeometry, m_RelatingElement, m_RelatedElement);
