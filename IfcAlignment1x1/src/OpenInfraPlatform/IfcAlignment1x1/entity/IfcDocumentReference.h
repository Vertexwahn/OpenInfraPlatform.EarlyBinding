...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcDocumentReference : public IfcExternalReference, public IfcDocumentSelect
		...
		public:
			...
			std::shared_ptr<IfcDocumentInformation> m_ReferencedDocument;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcDocumentReference, m_Location, m_Identification, m_Name, m_Description, m_ReferencedDocument);
