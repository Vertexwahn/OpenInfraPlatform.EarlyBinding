...
VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcLShapeProfileDef, m_ProfileType, m_ProfileName, m_Position, m_Depth, m_Width, m_Thickness, m_FilletRadius, m_EdgeRadius, m_LegSlope);
