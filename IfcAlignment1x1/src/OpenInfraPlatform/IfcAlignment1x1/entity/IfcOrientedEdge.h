...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcOrientedEdge -----------------------
			// attributes:
			std::shared_ptr<IfcEdge> m_EdgeElement;
			std::shared_ptr<IfcBoolean> m_Orientation;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcOrientedEdge, m_EdgeStart, m_EdgeEnd, m_EdgeElement, m_Orientation);
