...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcLightIntensityDistribution : public IfcAlignment1x1Entity, public IfcLightDistributionDataSourceSelect
		...
		public:
			...
			// IfcLightIntensityDistribution -----------------------
			// attributes:
			std::shared_ptr<IfcLightDistributionCurveEnum> m_LightDistributionCurve;
			std::vector<std::shared_ptr<IfcLightDistributionData>>  m_DistributionData;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcLightIntensityDistribution, m_LightDistributionCurve, m_DistributionData);
