...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcPropertySetDefinition : public IfcPropertyDefinition, public IfcPropertySetDefinitionSelect
...
VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcPropertySetDefinition, m_GlobalId, m_OwnerHistory, m_Name, m_Description);
