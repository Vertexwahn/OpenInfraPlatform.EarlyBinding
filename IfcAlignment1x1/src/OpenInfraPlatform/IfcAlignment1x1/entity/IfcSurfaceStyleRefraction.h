...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcSurfaceStyleRefraction : public IfcPresentationItem, public IfcSurfaceStyleElementSelect
		...
		public:
			...
			// IfcSurfaceStyleRefraction -----------------------
			// attributes:
			std::shared_ptr<IfcReal> m_RefractionIndex;
			std::shared_ptr<IfcReal> m_DispersionFactor;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcSurfaceStyleRefraction, m_RefractionIndex, m_DispersionFactor);
