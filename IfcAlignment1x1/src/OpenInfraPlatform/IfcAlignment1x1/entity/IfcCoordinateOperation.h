...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcCoordinateOperation : public IfcAlignment1x1Entity
		{
		public:
			...
			// IfcCoordinateOperation -----------------------
			// attributes:
			std::shared_ptr<IfcCoordinateReferenceSystemSelect> m_SourceCRS;
			std::shared_ptr<IfcCoordinateReferenceSystem> m_TargetCRS;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcCoordinateOperation, m_SourceCRS, m_TargetCRS);
