...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcBoolean;
		// ENTITY IfcEdgeCurve
		class IfcEdgeCurve : public IfcEdge, public IfcCurveOrEdgeCurve
		...
		public:
			...
			// IfcEdgeCurve -----------------------
			// attributes:
			std::shared_ptr<IfcCurve> m_EdgeGeometry;
			std::shared_ptr<IfcBoolean> m_SameSense;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcEdgeCurve, m_EdgeStart, m_EdgeEnd, m_EdgeGeometry, m_SameSense);
