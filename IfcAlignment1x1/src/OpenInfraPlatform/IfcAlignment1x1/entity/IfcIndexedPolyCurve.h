...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcIndexedPolyCurve -----------------------
			// attributes:
			std::shared_ptr<IfcCartesianPointList> m_Points;
			std::vector<std::shared_ptr<IfcSegmentIndexSelect>>  m_Segments;
			std::shared_ptr<IfcBoolean> m_SelfIntersect;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcIndexedPolyCurve, m_Points, m_Segments, m_SelfIntersect);
