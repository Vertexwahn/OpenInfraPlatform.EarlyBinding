...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcUnitEnum;
		// ENTITY IfcNamedUnit
		class IfcNamedUnit : public IfcAlignment1x1Entity, public IfcUnit
		...
		public:
			...
			// IfcNamedUnit -----------------------
			// attributes:
			std::shared_ptr<IfcDimensionalExponents> m_Dimensions;
			std::shared_ptr<IfcUnitEnum> m_UnitType;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcNamedUnit, m_Dimensions, m_UnitType);
