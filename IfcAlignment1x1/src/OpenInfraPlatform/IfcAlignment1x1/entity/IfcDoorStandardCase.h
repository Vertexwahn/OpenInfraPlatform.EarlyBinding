...
VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcDoorStandardCase, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_ObjectType, m_ObjectPlacement, m_Representation, m_Tag, m_OverallHeight, m_OverallWidth, m_PredefinedType, m_OperationType, m_UserDefinedOperationType);
