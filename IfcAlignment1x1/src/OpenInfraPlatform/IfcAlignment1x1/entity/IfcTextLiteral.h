...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcTextLiteral -----------------------
			// attributes:
			std::shared_ptr<IfcPresentableText> m_Literal;
			std::shared_ptr<IfcAxis2Placement> m_Placement;
			std::shared_ptr<IfcTextPath> m_Path;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcTextLiteral, m_Literal, m_Placement, m_Path);
