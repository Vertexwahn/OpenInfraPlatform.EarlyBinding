...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcMetric -----------------------
			// attributes:
			std::shared_ptr<IfcBenchmarkEnum> m_Benchmark;
			std::shared_ptr<IfcLabel> m_ValueSource;
			std::shared_ptr<IfcMetricValueSelect> m_DataValue;
			std::shared_ptr<IfcReference> m_ReferencePath;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcMetric, m_Name, m_Description, m_ConstraintGrade, m_ConstraintSource, m_CreatingActor, m_CreationTime, m_UserDefinedGrade, m_Benchmark, m_ValueSource, m_DataValue, m_ReferencePath);
