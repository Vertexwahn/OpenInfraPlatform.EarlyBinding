...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcConnectionSurfaceGeometry -----------------------
			// attributes:
			std::shared_ptr<IfcSurfaceOrFaceSurface> m_SurfaceOnRelatingElement;
			std::shared_ptr<IfcSurfaceOrFaceSurface> m_SurfaceOnRelatedElement;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcConnectionSurfaceGeometry, m_SurfaceOnRelatingElement, m_SurfaceOnRelatedElement);
