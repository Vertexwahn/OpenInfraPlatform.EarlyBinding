...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcSectionedSolidHorizontal -----------------------
			// attributes:
			std::vector<std::shared_ptr<IfcDistanceExpression>>  m_CrossSectionPositions;
			std::shared_ptr<IfcBoolean> m_FixedAxisVertical;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcSectionedSolidHorizontal, m_Directrix, m_CrossSections, m_CrossSectionPositions, m_FixedAxisVertical);
