...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcOffsetCurve3D -----------------------
			// attributes:
			std::shared_ptr<IfcLengthMeasure> m_Distance;
...
VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcOffsetCurve3D, m_BasisCurve, m_Distance, m_SelfIntersect, m_RefDirection);
