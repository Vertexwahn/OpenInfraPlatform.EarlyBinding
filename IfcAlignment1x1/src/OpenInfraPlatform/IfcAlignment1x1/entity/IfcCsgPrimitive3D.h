...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcCsgPrimitive3D : public IfcGeometricRepresentationItem, public IfcBooleanOperand
, public IfcCsgSelect
...
VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcCsgPrimitive3D, m_Position);
