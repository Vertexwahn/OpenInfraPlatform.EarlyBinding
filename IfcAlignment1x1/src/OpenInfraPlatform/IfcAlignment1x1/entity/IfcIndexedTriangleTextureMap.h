...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcIndexedTriangleTextureMap -----------------------
			// attributes:
			std::vector<std::vector<std::shared_ptr<IfcPositiveInteger>>>  m_TexCoordIndex;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcIndexedTriangleTextureMap, m_Maps, m_MappedTo, m_TexCoords, m_TexCoordIndex);
