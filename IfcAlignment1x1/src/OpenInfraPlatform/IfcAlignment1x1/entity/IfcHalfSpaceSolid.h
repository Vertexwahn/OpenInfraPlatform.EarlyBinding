...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcHalfSpaceSolid : public IfcGeometricRepresentationItem, public IfcBooleanOperand
		...
		public:
			...
			// IfcHalfSpaceSolid -----------------------
			// attributes:
			std::shared_ptr<IfcSurface> m_BaseSurface;
			std::shared_ptr<IfcBoolean> m_AgreementFlag;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcHalfSpaceSolid, m_BaseSurface, m_AgreementFlag);
