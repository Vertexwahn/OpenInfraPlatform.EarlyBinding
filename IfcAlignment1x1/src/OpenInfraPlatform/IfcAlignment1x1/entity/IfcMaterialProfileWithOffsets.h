...
VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcMaterialProfileWithOffsets, m_Name, m_Description, m_Material, m_Profile, m_Priority, m_Category, m_OffsetValues);
