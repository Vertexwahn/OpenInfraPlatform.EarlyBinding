...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcQuantityWeight -----------------------
			// attributes:
			std::shared_ptr<IfcMassMeasure> m_WeightValue;
			std::shared_ptr<IfcLabel> m_Formula;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcQuantityWeight, m_Name, m_Description, m_Unit, m_WeightValue, m_Formula);
