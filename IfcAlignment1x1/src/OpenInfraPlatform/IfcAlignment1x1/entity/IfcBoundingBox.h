...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcBoundingBox -----------------------
			// attributes:
			std::shared_ptr<IfcCartesianPoint> m_Corner;
			std::shared_ptr<IfcPositiveLengthMeasure> m_XDim;
			std::shared_ptr<IfcPositiveLengthMeasure> m_YDim;
			std::shared_ptr<IfcPositiveLengthMeasure> m_ZDim;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcBoundingBox, m_Corner, m_XDim, m_YDim, m_ZDim);
