...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcSurfaceStyle : public IfcPresentationStyle, public IfcPresentationStyleSelect
		...
		public:
			...
			// IfcSurfaceStyle -----------------------
			// attributes:
			std::shared_ptr<IfcSurfaceSide> m_Side;
			std::vector<std::shared_ptr<IfcSurfaceStyleElementSelect>>  m_Styles;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcSurfaceStyle, m_Name, m_Side, m_Styles);
