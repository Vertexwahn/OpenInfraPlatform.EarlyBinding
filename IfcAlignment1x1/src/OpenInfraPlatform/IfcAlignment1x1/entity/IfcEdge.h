...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcEdge -----------------------
			// attributes:
			std::shared_ptr<IfcVertex> m_EdgeStart;
			std::shared_ptr<IfcVertex> m_EdgeEnd;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcEdge, m_EdgeStart, m_EdgeEnd);
