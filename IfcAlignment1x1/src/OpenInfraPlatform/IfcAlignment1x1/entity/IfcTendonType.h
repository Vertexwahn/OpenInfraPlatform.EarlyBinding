...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			std::shared_ptr<IfcPositiveLengthMeasure> m_SheathDiameter;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcTendonType, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_ApplicableOccurrence, m_HasPropertySets, m_RepresentationMaps, m_Tag, m_ElementType, m_PredefinedType, m_NominalDiameter, m_CrossSectionArea, m_SheathDiameter);
