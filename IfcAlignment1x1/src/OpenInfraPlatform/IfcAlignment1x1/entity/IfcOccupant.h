...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcOccupant -----------------------
			// attributes:
			std::shared_ptr<IfcOccupantTypeEnum> m_PredefinedType;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcOccupant, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_ObjectType, m_TheActor, m_PredefinedType);
