...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcStructuralLoadConfiguration -----------------------
			// attributes:
			std::vector<std::shared_ptr<IfcStructuralLoadOrResult>>  m_Values;
			std::vector<std::vector<std::shared_ptr<IfcLengthMeasure>>>  m_Locations;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcStructuralLoadConfiguration, m_Name, m_Values, m_Locations);
