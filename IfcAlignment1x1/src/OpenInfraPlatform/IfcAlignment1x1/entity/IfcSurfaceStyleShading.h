...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcSurfaceStyleShading : public IfcPresentationItem, public IfcSurfaceStyleElementSelect
		...
		public:
			...
			// IfcSurfaceStyleShading -----------------------
			// attributes:
			std::shared_ptr<IfcColourRgb> m_SurfaceColour;
			std::shared_ptr<IfcNormalisedRatioMeasure> m_Transparency;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcSurfaceStyleShading, m_SurfaceColour, m_Transparency);
