...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			std::shared_ptr<IfcDistributionSystemEnum> m_PredefinedType;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcDistributionSystem, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_ObjectType, m_LongName, m_PredefinedType);
