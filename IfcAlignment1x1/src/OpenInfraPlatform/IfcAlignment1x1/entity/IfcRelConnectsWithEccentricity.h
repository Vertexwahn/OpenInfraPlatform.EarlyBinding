...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcRelConnectsWithEccentricity -----------------------
			// attributes:
			std::shared_ptr<IfcConnectionGeometry> m_ConnectionConstraint;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcRelConnectsWithEccentricity, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_RelatingStructuralMember, m_RelatedStructuralConnection, m_AppliedCondition, m_AdditionalConditions, m_SupportedLength, m_ConditionCoordinateSystem, m_ConnectionConstraint);
