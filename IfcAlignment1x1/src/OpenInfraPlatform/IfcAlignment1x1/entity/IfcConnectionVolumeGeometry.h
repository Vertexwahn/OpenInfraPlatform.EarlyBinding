...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcConnectionVolumeGeometry -----------------------
			// attributes:
			std::shared_ptr<IfcSolidOrShell> m_VolumeOnRelatingElement;
			std::shared_ptr<IfcSolidOrShell> m_VolumeOnRelatedElement;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcConnectionVolumeGeometry, m_VolumeOnRelatingElement, m_VolumeOnRelatedElement);
