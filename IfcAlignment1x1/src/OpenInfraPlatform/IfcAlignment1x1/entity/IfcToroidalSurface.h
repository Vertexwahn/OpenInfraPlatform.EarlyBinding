...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcToroidalSurface -----------------------
			// attributes:
			std::shared_ptr<IfcPositiveLengthMeasure> m_MajorRadius;
			std::shared_ptr<IfcPositiveLengthMeasure> m_MinorRadius;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcToroidalSurface, m_Position, m_MajorRadius, m_MinorRadius);
