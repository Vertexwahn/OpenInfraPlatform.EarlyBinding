...
VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcDistributionElementType, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_ApplicableOccurrence, m_HasPropertySets, m_RepresentationMaps, m_Tag, m_ElementType);
