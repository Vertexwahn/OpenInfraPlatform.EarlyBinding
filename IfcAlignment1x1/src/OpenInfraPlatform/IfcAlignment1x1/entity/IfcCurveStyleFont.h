...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcCurveStyleFont : public IfcPresentationItem, public IfcCurveStyleFontSelect
		...
		public:
			...
			std::vector<std::shared_ptr<IfcCurveStyleFontPattern>>  m_PatternList;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcCurveStyleFont, m_Name, m_PatternList);
