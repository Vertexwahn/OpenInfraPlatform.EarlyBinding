...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcRelAssociatesClassification -----------------------
			// attributes:
			std::shared_ptr<IfcClassificationSelect> m_RelatingClassification;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcRelAssociatesClassification, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_RelatedObjects, m_RelatingClassification);
