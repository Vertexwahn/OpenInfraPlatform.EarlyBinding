...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcClassification : public IfcExternalInformation, public IfcClassificationReferenceSelect
, public IfcClassificationSelect
		...
		public:
			...
			// IfcClassification -----------------------
			// attributes:
			std::shared_ptr<IfcLabel> m_Source;
			std::shared_ptr<IfcLabel> m_Edition;
			std::shared_ptr<IfcDate> m_EditionDate;
			std::shared_ptr<IfcLabel> m_Name;
			std::shared_ptr<IfcText> m_Description;
			std::shared_ptr<IfcURIReference> m_Location;
			std::vector<std::shared_ptr<IfcIdentifier>>  m_ReferenceTokens;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcClassification, m_Source, m_Edition, m_EditionDate, m_Name, m_Description, m_Location, m_ReferenceTokens);
