...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcRelServicesBuildings -----------------------
			// attributes:
			std::shared_ptr<IfcSystem> m_RelatingSystem;
			std::vector<std::shared_ptr<IfcSpatialElement>>  m_RelatedBuildings;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcRelServicesBuildings, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_RelatingSystem, m_RelatedBuildings);
