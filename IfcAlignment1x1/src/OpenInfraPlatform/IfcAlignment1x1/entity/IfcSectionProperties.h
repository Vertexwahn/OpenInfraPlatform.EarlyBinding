...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcSectionProperties -----------------------
			// attributes:
			std::shared_ptr<IfcSectionTypeEnum> m_SectionType;
			std::shared_ptr<IfcProfileDef> m_StartProfile;
			std::shared_ptr<IfcProfileDef> m_EndProfile;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcSectionProperties, m_SectionType, m_StartProfile, m_EndProfile);
