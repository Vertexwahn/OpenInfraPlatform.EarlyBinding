...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcPerformanceHistory -----------------------
			// attributes:
			std::shared_ptr<IfcLabel> m_LifeCyclePhase;
			std::shared_ptr<IfcPerformanceHistoryTypeEnum> m_PredefinedType;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcPerformanceHistory, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_ObjectType, m_Identification, m_LifeCyclePhase, m_PredefinedType);
