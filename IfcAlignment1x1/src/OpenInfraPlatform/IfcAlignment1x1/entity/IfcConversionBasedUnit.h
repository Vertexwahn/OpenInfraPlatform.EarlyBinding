...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcConversionBasedUnit : public IfcNamedUnit, public IfcResourceObjectSelect
		...
		public:
			...
			std::shared_ptr<IfcMeasureWithUnit> m_ConversionFactor;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcConversionBasedUnit, m_Dimensions, m_UnitType, m_Name, m_ConversionFactor);
