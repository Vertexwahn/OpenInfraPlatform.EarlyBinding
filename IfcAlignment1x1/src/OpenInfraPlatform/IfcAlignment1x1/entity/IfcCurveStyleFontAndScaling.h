...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcCurveStyleFontAndScaling : public IfcPresentationItem, public IfcCurveFontOrScaledCurveFontSelect
		...
		public:
			...
			std::shared_ptr<IfcCurveStyleFontSelect> m_CurveFont;
			std::shared_ptr<IfcPositiveRatioMeasure> m_CurveFontScaling;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcCurveStyleFontAndScaling, m_Name, m_CurveFont, m_CurveFontScaling);
