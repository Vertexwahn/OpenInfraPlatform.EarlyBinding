...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			std::shared_ptr<IfcPositiveLengthMeasure> m_BottomRadius;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcRightCircularCone, m_Position, m_Height, m_BottomRadius);
