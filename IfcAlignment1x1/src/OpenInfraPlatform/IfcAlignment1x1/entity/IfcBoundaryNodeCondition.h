...
VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcBoundaryNodeCondition, m_Name, m_TranslationalStiffnessX, m_TranslationalStiffnessY, m_TranslationalStiffnessZ, m_RotationalStiffnessX, m_RotationalStiffnessY, m_RotationalStiffnessZ);
