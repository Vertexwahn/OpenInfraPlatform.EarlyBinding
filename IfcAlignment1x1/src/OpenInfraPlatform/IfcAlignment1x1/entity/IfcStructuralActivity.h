...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcStructuralActivity -----------------------
			// attributes:
			std::shared_ptr<IfcStructuralLoad> m_AppliedLoad;
			std::shared_ptr<IfcGlobalOrLocalEnum> m_GlobalOrLocal;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcStructuralActivity, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_ObjectType, m_ObjectPlacement, m_Representation, m_AppliedLoad, m_GlobalOrLocal);
