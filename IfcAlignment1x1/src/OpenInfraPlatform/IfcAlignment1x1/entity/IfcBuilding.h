...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcBuilding -----------------------
			// attributes:
			std::shared_ptr<IfcLengthMeasure> m_ElevationOfRefHeight;
			std::shared_ptr<IfcLengthMeasure> m_ElevationOfTerrain;
			std::shared_ptr<IfcPostalAddress> m_BuildingAddress;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcBuilding, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_ObjectType, m_ObjectPlacement, m_Representation, m_LongName, m_CompositionType, m_ElevationOfRefHeight, m_ElevationOfTerrain, m_BuildingAddress);
