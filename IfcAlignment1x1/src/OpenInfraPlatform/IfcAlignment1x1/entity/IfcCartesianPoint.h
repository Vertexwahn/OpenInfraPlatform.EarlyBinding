...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcCartesianPoint : public IfcPoint, public IfcTrimmingSelect
		...
		public:
			...
			// IfcCartesianPoint -----------------------
			// attributes:
			std::vector<std::shared_ptr<IfcLengthMeasure>>  m_Coordinates;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcCartesianPoint, m_Coordinates);
