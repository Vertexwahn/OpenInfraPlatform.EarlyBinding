...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcMaterialLayerSetUsage -----------------------
			// attributes:
			std::shared_ptr<IfcMaterialLayerSet> m_ForLayerSet;
			std::shared_ptr<IfcLayerSetDirectionEnum> m_LayerSetDirection;
			std::shared_ptr<IfcDirectionSenseEnum> m_DirectionSense;
			std::shared_ptr<IfcLengthMeasure> m_OffsetFromReferenceLine;
			std::shared_ptr<IfcPositiveLengthMeasure> m_ReferenceExtent;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcMaterialLayerSetUsage, m_ForLayerSet, m_LayerSetDirection, m_DirectionSense, m_OffsetFromReferenceLine, m_ReferenceExtent);
