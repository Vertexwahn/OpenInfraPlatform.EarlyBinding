...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcRelConnectsPorts -----------------------
			// attributes:
			std::shared_ptr<IfcPort> m_RelatingPort;
			std::shared_ptr<IfcPort> m_RelatedPort;
			std::shared_ptr<IfcElement> m_RealizingElement;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcRelConnectsPorts, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_RelatingPort, m_RelatedPort, m_RealizingElement);
