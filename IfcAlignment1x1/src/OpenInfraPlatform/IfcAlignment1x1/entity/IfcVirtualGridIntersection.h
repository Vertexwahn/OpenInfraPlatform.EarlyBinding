...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcVirtualGridIntersection : public IfcAlignment1x1Entity, public IfcGridPlacementDirectionSelect
		...
		public:
			...
			// IfcVirtualGridIntersection -----------------------
			// attributes:
			std::vector<std::shared_ptr<IfcGridAxis>>  m_IntersectingAxes;
			std::vector<std::shared_ptr<IfcLengthMeasure>>  m_OffsetDistances;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcVirtualGridIntersection, m_IntersectingAxes, m_OffsetDistances);
