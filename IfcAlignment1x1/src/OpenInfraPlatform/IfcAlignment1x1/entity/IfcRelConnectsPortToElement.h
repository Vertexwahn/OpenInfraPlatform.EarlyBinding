...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			std::shared_ptr<IfcDistributionElement> m_RelatedElement;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcRelConnectsPortToElement, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_RelatingPort, m_RelatedElement);
