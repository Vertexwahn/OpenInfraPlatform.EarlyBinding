...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcStructuralSurfaceAction -----------------------
			// attributes:
			std::shared_ptr<IfcProjectedOrTrueLengthEnum> m_ProjectedOrTrue;
			std::shared_ptr<IfcStructuralSurfaceActivityTypeEnum> m_PredefinedType;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcStructuralSurfaceAction, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_ObjectType, m_ObjectPlacement, m_Representation, m_AppliedLoad, m_GlobalOrLocal, m_DestabilizingLoad, m_ProjectedOrTrue, m_PredefinedType);
