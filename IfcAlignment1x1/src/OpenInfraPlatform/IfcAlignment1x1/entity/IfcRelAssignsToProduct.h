...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcRelAssignsToProduct -----------------------
			// attributes:
			std::shared_ptr<IfcProductSelect> m_RelatingProduct;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcRelAssignsToProduct, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_RelatedObjects, m_RelatedObjectsType, m_RelatingProduct);
