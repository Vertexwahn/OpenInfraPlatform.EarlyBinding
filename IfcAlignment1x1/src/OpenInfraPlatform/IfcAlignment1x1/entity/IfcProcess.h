...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcText;
		// ENTITY IfcProcess
		class IfcProcess : public IfcObject, public IfcProcessSelect
...
VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcProcess, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_ObjectType, m_Identification, m_LongDescription);
