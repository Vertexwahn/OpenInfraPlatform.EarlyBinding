...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			std::shared_ptr<IfcDirection> m_FixedReference;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcFixedReferenceSweptAreaSolid, m_SweptArea, m_Position, m_Directrix, m_StartParam, m_EndParam, m_FixedReference);
