...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcExternallyDefinedTextFont : public IfcExternalReference, public IfcTextFontSelect
...
VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcExternallyDefinedTextFont, m_Location, m_Identification, m_Name);
