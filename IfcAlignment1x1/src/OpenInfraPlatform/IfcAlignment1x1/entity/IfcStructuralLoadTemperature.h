...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcStructuralLoadTemperature -----------------------
			// attributes:
			std::shared_ptr<IfcThermodynamicTemperatureMeasure> m_DeltaTConstant;
			std::shared_ptr<IfcThermodynamicTemperatureMeasure> m_DeltaTY;
			std::shared_ptr<IfcThermodynamicTemperatureMeasure> m_DeltaTZ;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcStructuralLoadTemperature, m_Name, m_DeltaTConstant, m_DeltaTY, m_DeltaTZ);
