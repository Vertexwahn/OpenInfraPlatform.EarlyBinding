...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcPropertyDependencyRelationship -----------------------
			// attributes:
			std::shared_ptr<IfcProperty> m_DependingProperty;
			std::shared_ptr<IfcProperty> m_DependantProperty;
			std::shared_ptr<IfcText> m_Expression;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcPropertyDependencyRelationship, m_Name, m_Description, m_DependingProperty, m_DependantProperty, m_Expression);
