...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcQuantityArea -----------------------
			// attributes:
			std::shared_ptr<IfcAreaMeasure> m_AreaValue;
			std::shared_ptr<IfcLabel> m_Formula;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcQuantityArea, m_Name, m_Description, m_Unit, m_AreaValue, m_Formula);
