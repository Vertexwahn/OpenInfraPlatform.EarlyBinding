...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		class IfcMeasureWithUnit : public IfcAlignment1x1Entity, public IfcAppliedValueSelect
, public IfcMetricValueSelect
		...
		public:
			...
			// IfcMeasureWithUnit -----------------------
			// attributes:
			std::shared_ptr<IfcValue> m_ValueComponent;
			std::shared_ptr<IfcUnit> m_UnitComponent;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcMeasureWithUnit, m_ValueComponent, m_UnitComponent);
