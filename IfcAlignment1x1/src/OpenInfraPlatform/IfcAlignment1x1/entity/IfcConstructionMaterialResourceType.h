...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcConstructionMaterialResourceType -----------------------
			// attributes:
			std::shared_ptr<IfcConstructionMaterialResourceTypeEnum> m_PredefinedType;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcConstructionMaterialResourceType, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_ApplicableOccurrence, m_HasPropertySets, m_Identification, m_LongDescription, m_ResourceType, m_BaseCosts, m_BaseQuantity, m_PredefinedType);
