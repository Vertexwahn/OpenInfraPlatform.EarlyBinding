...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcBoxedHalfSpace -----------------------
			// attributes:
			std::shared_ptr<IfcBoundingBox> m_Enclosure;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcBoxedHalfSpace, m_BaseSurface, m_AgreementFlag, m_Enclosure);
