...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcBeamType -----------------------
			// attributes:
			std::shared_ptr<IfcBeamTypeEnum> m_PredefinedType;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcBeamType, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_ApplicableOccurrence, m_HasPropertySets, m_RepresentationMaps, m_Tag, m_ElementType, m_PredefinedType);
