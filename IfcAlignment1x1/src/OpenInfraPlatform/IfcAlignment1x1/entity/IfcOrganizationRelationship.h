...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcOrganizationRelationship -----------------------
			// attributes:
			std::shared_ptr<IfcOrganization> m_RelatingOrganization;
			std::vector<std::shared_ptr<IfcOrganization>>  m_RelatedOrganizations;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcOrganizationRelationship, m_Name, m_Description, m_RelatingOrganization, m_RelatedOrganizations);
