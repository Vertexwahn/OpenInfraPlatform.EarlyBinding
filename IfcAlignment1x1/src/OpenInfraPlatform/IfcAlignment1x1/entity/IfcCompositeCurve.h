...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcCompositeCurve -----------------------
			// attributes:
			std::vector<std::shared_ptr<IfcCompositeCurveSegment>>  m_Segments;
			std::shared_ptr<IfcLogical> m_SelfIntersect;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcCompositeCurve, m_Segments, m_SelfIntersect);
