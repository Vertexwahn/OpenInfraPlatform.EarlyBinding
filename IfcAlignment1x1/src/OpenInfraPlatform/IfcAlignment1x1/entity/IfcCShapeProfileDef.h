...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			std::shared_ptr<IfcPositiveLengthMeasure> m_Girth;
			std::shared_ptr<IfcNonNegativeLengthMeasure> m_InternalFilletRadius;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcCShapeProfileDef, m_ProfileType, m_ProfileName, m_Position, m_Depth, m_Width, m_WallThickness, m_Girth, m_InternalFilletRadius);
