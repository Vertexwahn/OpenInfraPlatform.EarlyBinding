...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcSweptDiskSolidPolygonal -----------------------
			// attributes:
			std::shared_ptr<IfcPositiveLengthMeasure> m_FilletRadius;
		};
	}
}

VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcSweptDiskSolidPolygonal, m_Directrix, m_Radius, m_InnerRadius, m_StartParam, m_EndParam, m_FilletRadius);
