...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcConstructionResource -----------------------
			// attributes:
			std::shared_ptr<IfcResourceTime> m_Usage;
...
VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcConstructionResource, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_ObjectType, m_Identification, m_LongDescription, m_Usage, m_BaseCosts, m_BaseQuantity);
