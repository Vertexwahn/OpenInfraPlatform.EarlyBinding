...
VISITABLE_STRUCT(OpenInfraPlatform::IfcAlignment1x1::IfcDistributionCircuit, m_GlobalId, m_OwnerHistory, m_Name, m_Description, m_ObjectType, m_LongName, m_PredefinedType);
