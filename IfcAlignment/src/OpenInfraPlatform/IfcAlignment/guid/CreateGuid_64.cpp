...
namespace OpenInfraPlatform
{
	namespace IfcAlignment
	{
		...
		{
			// For debugging reasons it makes sense to use the same GUIDs every time
			if (!true)
			{
				std::string fakeGUIDs[10];
				fakeGUIDs[0] = "1wjO$KezHDwuaenhWVVpK6";
				fakeGUIDs[1] = "10KvPx1RLEBf0D2RG6tpul";
				fakeGUIDs[2] = "3wWAhaw5109hA69fDiIinr";
				fakeGUIDs[3] = "3Gov2cnwn7Xel_DqD91$5W";
				fakeGUIDs[4] = "0QT15$fzrEARaOhFmImC95";
				fakeGUIDs[5] = "35GQjjdJf7UOO6SAomjBY9";

				static int index = 0;
				if (index < 6)
				{
					return fakeGUIDs[index++];
				}
			}
