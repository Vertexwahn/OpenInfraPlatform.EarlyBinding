...
namespace OpenInfraPlatform
{
	...
	{
		class IfcObjectReferenceSelect : public IfcAlignmentP6AbstractSelect
		{
		public:
			...
			static shared_ptr<IfcObjectReferenceSelect> readStepData( std::string& arg, const std::map<int,shared_ptr<IfcAlignmentP6Entity> >& map );
		};
