...
namespace OpenInfraPlatform
{
	...
	{
		class IfcCoordinateReferenceSystemSelect : public IfcAlignmentP6AbstractSelect
		{
		public:
			...
			static shared_ptr<IfcCoordinateReferenceSystemSelect> readStepData( std::string& arg, const std::map<int,shared_ptr<IfcAlignmentP6Entity> >& map );
		};
