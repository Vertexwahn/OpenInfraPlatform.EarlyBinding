...
namespace OpenInfraPlatform
{
	namespace IfcAlignment
	{
		...
		//ENTITY
		class IfcAlignment : public IfcPositioningElement
		{
		public:
			IfcAlignment();
			IfcAlignment( int id );
			...
			shared_ptr<IfcAlignment2DHorizontal>							m_Horizontal;				//optional
			shared_ptr<IfcAlignment2DVertical>							m_Vertical;					//optional
			shared_ptr<IfcLabel>											m_LinearRefMethod;			//optional
			// inverse attributes:
