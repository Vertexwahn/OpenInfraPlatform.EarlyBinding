...
namespace OpenInfraPlatform
{
	namespace IfcAlignment
	{
		...
		IfcClassificationReferenceSelect::~IfcClassificationReferenceSelect() {}
		shared_ptr<IfcClassificationReferenceSelect> IfcClassificationReferenceSelect::readStepData( std::string& arg, const std::map<int,shared_ptr<IfcAlignmentP6Entity> >& map )
		{
			// Read SELECT TYPE
