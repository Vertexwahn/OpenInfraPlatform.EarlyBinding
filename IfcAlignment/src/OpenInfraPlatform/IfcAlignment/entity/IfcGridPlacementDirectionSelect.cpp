...
namespace OpenInfraPlatform
{
	namespace IfcAlignment
	{
		...
		IfcGridPlacementDirectionSelect::~IfcGridPlacementDirectionSelect() {}
		shared_ptr<IfcGridPlacementDirectionSelect> IfcGridPlacementDirectionSelect::readStepData( std::string& arg, const std::map<int,shared_ptr<IfcAlignmentP6Entity> >& map )
		{
			// Read SELECT TYPE
