...
namespace OpenInfraPlatform
{
	namespace IfcAlignment
	{
		...
		void IfcObjectPlacement::setEntity( shared_ptr<IfcAlignmentP6Entity> other_entity )
		{
		...
		void IfcObjectPlacement::readStepData( std::vector<std::string>& args, const std::map<int,shared_ptr<IfcAlignmentP6Entity> >& map )
		{
		}
		void IfcObjectPlacement::setInverseCounterparts( shared_ptr<IfcAlignmentP6Entity> )
		{
		}
