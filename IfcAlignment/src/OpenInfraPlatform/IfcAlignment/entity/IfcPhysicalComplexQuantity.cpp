...
namespace OpenInfraPlatform
{
	namespace IfcAlignment
	{
		...
		void IfcPhysicalComplexQuantity::setEntity( shared_ptr<IfcAlignmentP6Entity> other_entity )
		{
		...
		void IfcPhysicalComplexQuantity::setInverseCounterparts( shared_ptr<IfcAlignmentP6Entity> ptr_self_entity )
		{
			...
			if( !ptr_self ) { throw IfcAlignmentP6Exception( "IfcPhysicalComplexQuantity::setInverseCounterparts: type mismatch" ); }
