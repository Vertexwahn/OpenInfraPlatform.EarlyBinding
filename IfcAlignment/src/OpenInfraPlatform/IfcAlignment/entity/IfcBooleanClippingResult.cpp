...
namespace OpenInfraPlatform
{
	namespace IfcAlignment
	{
		...
		void IfcBooleanClippingResult::setEntity( shared_ptr<IfcAlignmentP6Entity> other_entity )
		{
		...
		void IfcBooleanClippingResult::setInverseCounterparts( shared_ptr<IfcAlignmentP6Entity> ptr_self_entity )
		{
