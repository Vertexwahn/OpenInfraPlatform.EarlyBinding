...
namespace OpenInfraPlatform
{
	namespace IfcAlignment
	{
		...
		IfcTranslationalStiffnessSelect::~IfcTranslationalStiffnessSelect() {}
		shared_ptr<IfcTranslationalStiffnessSelect> IfcTranslationalStiffnessSelect::readStepData( std::string& arg, const std::map<int,shared_ptr<IfcAlignmentP6Entity> >& map )
		{
			// Read SELECT TYPE
