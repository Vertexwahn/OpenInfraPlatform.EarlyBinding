...
namespace OpenInfraPlatform
{
	namespace IfcAlignment
	{
		...
		IfcRotationalStiffnessSelect::~IfcRotationalStiffnessSelect() {}
		shared_ptr<IfcRotationalStiffnessSelect> IfcRotationalStiffnessSelect::readStepData( std::string& arg, const std::map<int,shared_ptr<IfcAlignmentP6Entity> >& map )
		{
			// Read SELECT TYPE
