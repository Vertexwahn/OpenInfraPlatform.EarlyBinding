...
namespace OpenInfraPlatform
{
	namespace IfcAlignment
	{
		...
		IfcWarpingStiffnessSelect::~IfcWarpingStiffnessSelect() {}
		shared_ptr<IfcWarpingStiffnessSelect> IfcWarpingStiffnessSelect::readStepData( std::string& arg, const std::map<int,shared_ptr<IfcAlignmentP6Entity> >& map )
		{
			// Read SELECT TYPE
			...
			else
			{
				...
				std::stringstream strs;
				strs << "unhandled inline argument: " << arg << " in function IFC4::IfcWarpingStiffnessSelect::readStepData" << std::endl;
				throw IfcAlignmentP6Exception( strs.str() );
			}
			return shared_ptr<IfcWarpingStiffnessSelect>();
		}
