...
namespace OpenInfraPlatform
{
	namespace IfcAlignment
	{
		...
		IfcModulusOfRotationalSubgradeReactionSelect::~IfcModulusOfRotationalSubgradeReactionSelect() {}
		shared_ptr<IfcModulusOfRotationalSubgradeReactionSelect> IfcModulusOfRotationalSubgradeReactionSelect::readStepData( std::string& arg, const std::map<int,shared_ptr<IfcAlignmentP6Entity> >& map )
		{
			// Read SELECT TYPE
