...
#include <iostream>
#include <time.h>
#include "entity/IfcLabel.h"
#include "entity/IfcIdentifier.h"
#include "entity/IfcUnitEnum.h"
#include "entity/IfcSIUnitName.h"
#include "entity/IfcLengthMeasure.h"
#include "entity/IfcChangeActionEnum.h"
#include "entity/IfcValue.h"
#include "entity/IfcPlaneAngleMeasure.h"
#include "entity/IfcGloballyUniqueId.h"
#include "entity/IfcDimensionCount.h"
#include "entity/IfcPerson.h"
#include "entity/IfcOrganization.h"
#include "entity/IfcPersonAndOrganization.h"
#include "entity/IfcApplication.h"
#include "entity/IfcSIUnit.h"
#include "entity/IfcCartesianPoint.h"
#include "entity/IfcAxis2Placement3D.h"
#include "entity/IfcOwnerHistory.h"
#include "entity/IfcDimensionalExponents.h"
#include "entity/IfcMeasureWithUnit.h"
#include "entity/IfcConversionBasedUnit.h"
#include "entity/IfcUnitAssignment.h"
#include "entity/IfcProject.h"
#include "entity/IfcGeometricRepresentationContext.h"
#include "entity/IfcProduct.h"
#include "entity/IfcDirection.h"
#include "entity/IfcReal.h"
...
namespace OpenInfraPlatform
{
    ...
    {
        IfcAlignment1x1Model::IfcAlignment1x1Model()
        {
            m_unit_converter = shared_ptr<UnitConverter>( new UnitConverter() );
            initFileHeader( "IfcAlignment1x1-export.ifc" );
        }
        ...
        void IfcAlignment1x1Model::initIfcModel()
        {
            clearIfcModel();
            ...
            app->m_ApplicationFullName = shared_ptr<IfcLabel>( new IfcLabel( "IfcAlignment1x1" ) );
            app->m_ApplicationIdentifier = shared_ptr<IfcIdentifier>( new IfcIdentifier( "IfcAlignment1x1" ) );
            insertEntity(app);
            ...
            project->m_Name = shared_ptr<IfcLabel>(new IfcLabel( "IfcAlignment1x1 project" ) );
        ...
        shared_ptr<IfcProject> IfcAlignment1x1Model::getIfcProject()
        {
            return m_ifc_project;
        }
        shared_ptr<IfcGeometricRepresentationContext> IfcAlignment1x1Model::getIfcGeometricRepresentationContext3D()
        {
            return m_geom_context_3d;
        }

        void IfcAlignment1x1Model::setIfcProject( shared_ptr<IfcProject> project )
        {
            m_ifc_project = project;
        }

        void IfcAlignment1x1Model::insertEntity( shared_ptr<IfcAlignment1x1Entity> e, bool overwrite_existing )
        {
            ...
            std::map<int,shared_ptr<IfcAlignment1x1Entity> >::iterator lb = m_map_entities.lower_bound( entity_id );
            ...
            if( lb != m_map_entities.end() && !(m_map_entities.key_comp()(entity_id, lb->first)) )
            {
                ...
                else
                {
                    ...
                    strs << "IfcAlignment1x1Model::insertEntity: entity with id " << entity_id << " already exists in model" << std::endl;
                    throw IfcAlignment1x1Exception( strs.str().c_str() );
                }
            }
            else
            {
                // the key does not exist in the map
                m_map_entities.insert( lb, std::map<int,shared_ptr<IfcAlignment1x1Entity> >::value_type( entity_id, e ) );
            }

            // TODO: if type is IfcRoot (or subtype), and GlobalID not set, create one
        }

        void IfcAlignment1x1Model::removeEntity( shared_ptr<IfcAlignment1x1Entity> e )
        {
            int remove_id = e->getId();
            std::map<int,shared_ptr<IfcAlignment1x1Entity> >::iterator it_find = m_map_entities.find(remove_id);
            if( it_find != m_map_entities.end() )
            {
                shared_ptr<IfcAlignment1x1Entity> entity_found( it_find->second );
                entity_found->unlinkSelf();
                m_map_entities.erase( it_find );
            }
        }

        void IfcAlignment1x1Model::removeEntity( int entity_id )
        {
            std::map<int,shared_ptr<IfcAlignment1x1Entity> >::iterator it_find = m_map_entities.find(entity_id);
            if( it_find != m_map_entities.end() )
            {
                shared_ptr<IfcAlignment1x1Entity> entity_found( it_find->second );
                entity_found->unlinkSelf();
        ...
        int IfcAlignment1x1Model::getMaxUsedEntityId()
        {
            ...
            std::map<int,shared_ptr<IfcAlignment1x1Entity> >::iterator it_entities = m_map_entities.end();
            --it_entities;
        ...
        void IfcAlignment1x1Model::initFileHeader( std::string file_name )
        {
			std::stringstream strs;
        ...
        void IfcAlignment1x1Model::setFileHeader( std::string header )
        {
            m_file_header = header;
        }

        void IfcAlignment1x1Model::setFileSchema( std::string schema )
        {
            m_file_schema = schema;
        }

        void IfcAlignment1x1Model::clearIfcModel()
        {
            m_ifc_project.reset();
            m_geom_context_3d.reset();

            std::map<int,shared_ptr<IfcAlignment1x1Entity> >::iterator it_entities;
            for( it_entities = m_map_entities.begin(); it_entities != m_map_entities.end(); ++it_entities )
            {
                shared_ptr<IfcAlignment1x1Entity> entity( it_entities->second );
                entity->unlinkSelf();
            }
            m_map_entities.clear();
        }

        void IfcAlignment1x1Model::resetIfcModel()
        {
            clearIfcModel();
            initIfcModel();
            updateCache();
        ...
        void IfcAlignment1x1Model::updateCache()
        {
            bool found_project = false;
            bool found_geom_context = false;

            // try to find IfcProject and IfcGeometricRepresentationContext
            std::map<int,shared_ptr<IfcAlignment1x1Entity> >::iterator it;
            std::map<int,shared_ptr<IfcAlignment1x1Entity> >::iterator it_end = m_map_entities.end();
        ...
        void IfcAlignment1x1Model::clearCache()
        {
            m_ifc_project.reset();
            m_geom_context_3d.reset();
        }

        void IfcAlignment1x1Model::resolveInverseAttributes()
        {
