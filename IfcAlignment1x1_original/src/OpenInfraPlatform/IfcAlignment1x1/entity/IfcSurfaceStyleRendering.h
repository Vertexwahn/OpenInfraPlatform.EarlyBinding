...
namespace OpenInfraPlatform
{
	namespace IfcAlignment1x1
	{
		...
		public:
			...
			// IfcSurfaceStyleRendering -----------------------
			// attributes:
			std::shared_ptr<IfcColourOrFactor> m_DiffuseColour;
			std::shared_ptr<IfcColourOrFactor> m_TransmissionColour;
			std::shared_ptr<IfcColourOrFactor> m_DiffuseTransmissionColour;
			std::shared_ptr<IfcColourOrFactor> m_ReflectionColour;
			std::shared_ptr<IfcColourOrFactor> m_SpecularColour;
			std::shared_ptr<IfcSpecularHighlightSelect> m_SpecularHighlight;
			std::shared_ptr<IfcReflectanceMethodEnum> m_ReflectanceMethod;
		};
	}
}
