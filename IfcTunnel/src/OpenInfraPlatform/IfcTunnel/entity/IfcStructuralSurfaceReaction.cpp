...
namespace OpenInfraPlatform
{
	namespace IfcTunnel
	{
		...
		void IfcStructuralSurfaceReaction::setEntity( shared_ptr<IfcTunnelEntity> other_entity )
		{
		...
		void IfcStructuralSurfaceReaction::setInverseCounterparts( shared_ptr<IfcTunnelEntity> ptr_self_entity )
		{
