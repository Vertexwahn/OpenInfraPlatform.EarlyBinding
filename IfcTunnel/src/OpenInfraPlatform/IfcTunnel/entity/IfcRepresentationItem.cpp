...
namespace OpenInfraPlatform
{
	namespace IfcTunnel
	{
		...
		void IfcRepresentationItem::setEntity( shared_ptr<IfcTunnelEntity> other_entity )
		{
		...
		void IfcRepresentationItem::readStepData( std::vector<std::string>& args, const std::map<int,shared_ptr<IfcTunnelEntity> >& map )
		{
		}
		void IfcRepresentationItem::setInverseCounterparts( shared_ptr<IfcTunnelEntity> )
		{
		}
