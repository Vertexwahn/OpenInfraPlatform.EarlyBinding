...
namespace OpenInfraPlatform
{
	namespace IfcTunnel
	{
		...
		void IfcRecurrencePattern::setEntity( shared_ptr<IfcTunnelEntity> other_entity )
		{
		...
		void IfcRecurrencePattern::setInverseCounterparts( shared_ptr<IfcTunnelEntity> )
		{
		}
