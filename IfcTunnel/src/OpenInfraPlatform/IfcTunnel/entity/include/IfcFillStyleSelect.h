...
namespace OpenInfraPlatform
{
	namespace IfcTunnel
	{
		class IfcFillStyleSelect : public IfcTunnelAbstractSelect
		{
		public:
			IfcFillStyleSelect();
			~IfcFillStyleSelect();
			...
			static shared_ptr<IfcFillStyleSelect> readStepData( std::string& arg, const std::map<int,shared_ptr<IfcTunnelEntity> >& map );
		};
