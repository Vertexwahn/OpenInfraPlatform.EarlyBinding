...
namespace OpenInfraPlatform
{
	namespace IfcTunnel
	{
		// TYPE IfcTunnelInstallationEnum = ENUMERATION OF	(SEGMENT	,WALKWAY	,TRAFFICLIGHT	,TRACKBEDCONCRETE	,FLOORCONCRETE		,TRACKBEDRAILS	,CABLEDUCT	,DRAINAGE	,USERDEFINED	,NOTDEFINED);
