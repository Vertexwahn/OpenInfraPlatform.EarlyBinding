...
namespace OpenInfraPlatform
{
	namespace IfcTunnel
	{
		class IfcMetricValueSelect : public IfcTunnelAbstractSelect
		{
		public:
			...
			static shared_ptr<IfcMetricValueSelect> readStepData( std::string& arg, const std::map<int,shared_ptr<IfcTunnelEntity> >& map );
		};
