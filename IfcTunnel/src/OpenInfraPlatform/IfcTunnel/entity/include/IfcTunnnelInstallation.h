...
#include "IfcTunnelElement.h"

namespace OpenInfraPlatform
{
	namespace IfcTunnel
	{
		class IfcTunnelInstallationEnum;
		//ENTITY
		class IfcTunnnelInstallation : public IfcTunnelElement
		{
		public:
			IfcTunnnelInstallation();
			IfcTunnnelInstallation( int id );
			~IfcTunnnelInstallation();
			...
			virtual const char* classname() const { return "IfcTunnnelInstallation"; }
			...
			// IfcTunnnelInstallation -----------------------------------------------------------
			// attributes:
			shared_ptr<IfcTunnelInstallationEnum>		m_TunnelInstallationType;
		};
