...
namespace OpenInfraPlatform
{
	namespace IfcTunnel
	{
		...
		void IfcPostalAddress::setEntity( shared_ptr<IfcTunnelEntity> other_entity )
		{
		...
		void IfcPostalAddress::setInverseCounterparts( shared_ptr<IfcTunnelEntity> ptr_self_entity )
		{
