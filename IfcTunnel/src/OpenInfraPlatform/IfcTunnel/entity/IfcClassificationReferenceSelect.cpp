...
namespace OpenInfraPlatform
{
	namespace IfcTunnel
	{
		...
		IfcClassificationReferenceSelect::~IfcClassificationReferenceSelect() {}
		shared_ptr<IfcClassificationReferenceSelect> IfcClassificationReferenceSelect::readStepData( std::string& arg, const std::map<int,shared_ptr<IfcTunnelEntity> >& map )
		{
			// Read SELECT TYPE
