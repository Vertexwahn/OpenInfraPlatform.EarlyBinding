...
namespace OpenInfraPlatform
{
	namespace IfcTunnel
	{
		...
		IfcTranslationalStiffnessSelect::~IfcTranslationalStiffnessSelect() {}
		shared_ptr<IfcTranslationalStiffnessSelect> IfcTranslationalStiffnessSelect::readStepData( std::string& arg, const std::map<int,shared_ptr<IfcTunnelEntity> >& map )
		{
			// Read SELECT TYPE
