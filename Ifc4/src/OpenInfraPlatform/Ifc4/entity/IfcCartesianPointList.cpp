...
namespace OpenInfraPlatform
{
	namespace Ifc4
	{
		...
		void IfcCartesianPointList::setEntity( shared_ptr<Ifc4Entity> other_entity )
		{
		...
		void IfcCartesianPointList::readStepData( std::vector<std::string>& args, const std::map<int,shared_ptr<Ifc4Entity> >& map )
		{
		}
		void IfcCartesianPointList::setInverseCounterparts( shared_ptr<Ifc4Entity> ptr_self_entity )
		{
