...
namespace OpenInfraPlatform
{
	namespace Ifc4
	{
		class IfcPresentationStyleSelect : public Ifc4AbstractSelect
		{
		public:
			...
			static shared_ptr<IfcPresentationStyleSelect> readStepData( std::string& arg, const std::map<int,shared_ptr<Ifc4Entity> >& map );
		};
	} // end namespace Ifc4
