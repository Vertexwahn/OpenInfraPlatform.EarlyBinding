...
namespace OpenInfraPlatform
{
	namespace Ifc4
	{
		class IfcProductRepresentationSelect : public Ifc4AbstractSelect
		{
		public:
			...
			static shared_ptr<IfcProductRepresentationSelect> readStepData( std::string& arg, const std::map<int,shared_ptr<Ifc4Entity> >& map );
		};
	} // end namespace Ifc4
